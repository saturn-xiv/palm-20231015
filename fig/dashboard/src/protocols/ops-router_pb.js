...
goog.exportSymbol('proto.palm.ops.router.v1.Ip', null, global);
goog.exportSymbol('proto.palm.ops.router.v1.Ip.Dhcp', null, global);
goog.exportSymbol('proto.palm.ops.router.v1.Ip.Static', null, global);
goog.exportSymbol('proto.palm.ops.router.v1.Ip.V4Case', null, global);
goog.exportSymbol('proto.palm.ops.router.v1.Lan', null, global);
goog.exportSymbol('proto.palm.ops.router.v1.RouterIndexRouleResponse', null, global);
goog.exportSymbol('proto.palm.ops.router.v1.RouterIndexRouleResponse.Item', null, global);
 ...
 * @constructor
 */
proto.palm.ops.router.v1.RouterIndexRouleResponse = function(opt_data) {
  jspb.Message.initialize(this, opt_data, 0, -1, proto.palm.ops.router.v1.RouterIndexRouleResponse.repeatedFields_, null);
};
goog.inherits(proto.palm.ops.router.v1.RouterIndexRouleResponse, jspb.Message);
if (goog.DEBUG && !COMPILED) {
  /**
   * @public
   * @override
   */
  proto.palm.ops.router.v1.RouterIndexRouleResponse.displayName = 'proto.palm.ops.router.v1.RouterIndexRouleResponse';
}
/**
 * Generated by JsPbCodeGenerator.
 * @param {Array=} opt_data Optional initial data array, typically from a
 ...
 * @constructor
 */
proto.palm.ops.router.v1.RouterIndexRouleResponse.Item = function(opt_data) {
  jspb.Message.initialize(this, opt_data, 0, -1, null, null);
};
goog.inherits(proto.palm.ops.router.v1.RouterIndexRouleResponse.Item, jspb.Message);
if (goog.DEBUG && !COMPILED) {
  /**
   * @public
   * @override
   */
  proto.palm.ops.router.v1.RouterIndexRouleResponse.Item.displayName = 'proto.palm.ops.router.v1.RouterIndexRouleResponse.Item';
}
/**
 * Generated by JsPbCodeGenerator.
 * @param {Array=} opt_data Optional initial data array, typically from a
 ...
 * @constructor
 */
proto.palm.ops.router.v1.Ip = function(opt_data) {
  jspb.Message.initialize(this, opt_data, 0, -1, null, proto.palm.ops.router.v1.Ip.oneofGroups_);
};
goog.inherits(proto.palm.ops.router.v1.Ip, jspb.Message);
if (goog.DEBUG && !COMPILED) {
  /**
   * @public
   * @override
   */
  proto.palm.ops.router.v1.Ip.displayName = 'proto.palm.ops.router.v1.Ip';
}
/**
 * Generated by JsPbCodeGenerator.
 * @param {Array=} opt_data Optional initial data array, typically from a
 ...
 * @constructor
 */
proto.palm.ops.router.v1.Ip.Dhcp = function(opt_data) {
  jspb.Message.initialize(this, opt_data, 0, -1, null, null);
};
goog.inherits(proto.palm.ops.router.v1.Ip.Dhcp, jspb.Message);
if (goog.DEBUG && !COMPILED) {
  /**
   * @public
   * @override
   */
  proto.palm.ops.router.v1.Ip.Dhcp.displayName = 'proto.palm.ops.router.v1.Ip.Dhcp';
}
/**
 * Generated by JsPbCodeGenerator.
 * @param {Array=} opt_data Optional initial data array, typically from a
 ...
 * @constructor
 */
proto.palm.ops.router.v1.Ip.Static = function(opt_data) {
  jspb.Message.initialize(this, opt_data, 0, -1, null, null);
};
goog.inherits(proto.palm.ops.router.v1.Ip.Static, jspb.Message);
if (goog.DEBUG && !COMPILED) {
  /**
   * @public
   * @override
   */
  proto.palm.ops.router.v1.Ip.Static.displayName = 'proto.palm.ops.router.v1.Ip.Static';
}
/**
 * Generated by JsPbCodeGenerator.
 * @param {Array=} opt_data Optional initial data array, typically from a
 ...
 * @return {!proto.palm.ops.router.v1.RouterUpdateHostRequest} returns this
 */
proto.palm.ops.router.v1.RouterUpdateHostRequest.prototype.clearIp = function() {
 ...
 * @return {boolean}
 */
proto.palm.ops.router.v1.RouterUpdateHostRequest.prototype.hasIp = function() {
 ...
 * @const
 */
proto.palm.ops.router.v1.RouterIndexRouleResponse.repeatedFields_ = [1];
 ...
 * @return {!Object}
 */
proto.palm.ops.router.v1.RouterIndexRouleResponse.prototype.toObject = function(opt_includeInstance) {
  return proto.palm.ops.router.v1.RouterIndexRouleResponse.toObject(opt_includeInstance, this);
};
 ...
 *     the JSPB instance for transitional soy proto support:
 *     http://goto/soy-param-migration
 * @param {!proto.palm.ops.router.v1.RouterIndexRouleResponse} msg The msg instance to transform.
 * @return {!Object}
 * @suppress {unusedLocalVariables} f is only used for nested messages
 */
proto.palm.ops.router.v1.RouterIndexRouleResponse.toObject = function(includeInstance, msg) {
  var f, obj = {
    itemsList: jspb.Message.toObjectList(msg.getItemsList(),
    proto.palm.ops.router.v1.RouterIndexRouleResponse.Item.toObject, includeInstance)
  };
 ...
 * Deserializes binary data (in protobuf wire format).
 * @param {jspb.ByteSource} bytes The bytes to deserialize.
 * @return {!proto.palm.ops.router.v1.RouterIndexRouleResponse}
 */
proto.palm.ops.router.v1.RouterIndexRouleResponse.deserializeBinary = function(bytes) {
  var reader = new jspb.BinaryReader(bytes);
  var msg = new proto.palm.ops.router.v1.RouterIndexRouleResponse;
  return proto.palm.ops.router.v1.RouterIndexRouleResponse.deserializeBinaryFromReader(msg, reader);
};
 ...
 * Deserializes binary data (in protobuf wire format) from the
 * given reader into the given message object.
 * @param {!proto.palm.ops.router.v1.RouterIndexRouleResponse} msg The message object to deserialize into.
 * @param {!jspb.BinaryReader} reader The BinaryReader to use.
 * @return {!proto.palm.ops.router.v1.RouterIndexRouleResponse}
 */
proto.palm.ops.router.v1.RouterIndexRouleResponse.deserializeBinaryFromReader = function(msg, reader) {
  while (reader.nextField()) {
    if (reader.isEndGroup()) {
      break;
    }
    ...
    switch (field) {
    case 1:
      var value = new proto.palm.ops.router.v1.RouterIndexRouleResponse.Item;
      reader.readMessage(value,proto.palm.ops.router.v1.RouterIndexRouleResponse.Item.deserializeBinaryFromReader);
      msg.addItems(value);
      break;
    default:
      reader.skipField();
 ...
 * @return {!Uint8Array}
 */
proto.palm.ops.router.v1.RouterIndexRouleResponse.prototype.serializeBinary = function() {
  var writer = new jspb.BinaryWriter();
  proto.palm.ops.router.v1.RouterIndexRouleResponse.serializeBinaryToWriter(this, writer);
  return writer.getResultBuffer();
};
 ...
 * Serializes the given message to binary data (in protobuf wire
 * format), writing to the given BinaryWriter.
 * @param {!proto.palm.ops.router.v1.RouterIndexRouleResponse} message
 * @param {!jspb.BinaryWriter} writer
 * @suppress {unusedLocalVariables} f is only used for nested messages
 */
proto.palm.ops.router.v1.RouterIndexRouleResponse.serializeBinaryToWriter = function(message, writer) {
  var f = undefined;
  ...
  if (f.length > 0) {
    writer.writeRepeatedMessage(
      1,
      f,
      proto.palm.ops.router.v1.RouterIndexRouleResponse.Item.serializeBinaryToWriter
    );
  }
};
 ...
 * @return {!Object}
 */
proto.palm.ops.router.v1.RouterIndexRouleResponse.Item.prototype.toObject = function(opt_includeInstance) {
  return proto.palm.ops.router.v1.RouterIndexRouleResponse.Item.toObject(opt_includeInstance, this);
};
 ...
 *     the JSPB instance for transitional soy proto support:
 *     http://goto/soy-param-migration
 * @param {!proto.palm.ops.router.v1.RouterIndexRouleResponse.Item} msg The msg instance to transform.
 * @return {!Object}
 * @suppress {unusedLocalVariables} f is only used for nested messages
 */
proto.palm.ops.router.v1.RouterIndexRouleResponse.Item.toObject = function(includeInstance, msg) {
  var f, obj = {
    id: jspb.Message.getFieldWithDefault(msg, 1, 0),
    rule: (f = msg.getRule()) && proto.palm.ops.router.v1.Rule.toObject(includeInstance, f)
  };
 ...
 * Deserializes binary data (in protobuf wire format).
 * @param {jspb.ByteSource} bytes The bytes to deserialize.
 * @return {!proto.palm.ops.router.v1.RouterIndexRouleResponse.Item}
 */
proto.palm.ops.router.v1.RouterIndexRouleResponse.Item.deserializeBinary = function(bytes) {
  var reader = new jspb.BinaryReader(bytes);
  var msg = new proto.palm.ops.router.v1.RouterIndexRouleResponse.Item;
  return proto.palm.ops.router.v1.RouterIndexRouleResponse.Item.deserializeBinaryFromReader(msg, reader);
};
 ...
 * Deserializes binary data (in protobuf wire format) from the
 * given reader into the given message object.
 * @param {!proto.palm.ops.router.v1.RouterIndexRouleResponse.Item} msg The message object to deserialize into.
 * @param {!jspb.BinaryReader} reader The BinaryReader to use.
 * @return {!proto.palm.ops.router.v1.RouterIndexRouleResponse.Item}
 */
proto.palm.ops.router.v1.RouterIndexRouleResponse.Item.deserializeBinaryFromReader = function(msg, reader) {
  while (reader.nextField()) {
    if (reader.isEndGroup()) {
      break;
    }
 ...
 * @return {!Uint8Array}
 */
proto.palm.ops.router.v1.RouterIndexRouleResponse.Item.prototype.serializeBinary = function() {
  var writer = new jspb.BinaryWriter();
  proto.palm.ops.router.v1.RouterIndexRouleResponse.Item.serializeBinaryToWriter(this, writer);
  return writer.getResultBuffer();
};
 ...
 * Serializes the given message to binary data (in protobuf wire
 * format), writing to the given BinaryWriter.
 * @param {!proto.palm.ops.router.v1.RouterIndexRouleResponse.Item} message
 * @param {!jspb.BinaryWriter} writer
 * @suppress {unusedLocalVariables} f is only used for nested messages
 */
proto.palm.ops.router.v1.RouterIndexRouleResponse.Item.serializeBinaryToWriter = function(message, writer) {
  var f = undefined;
  f = message.getId();
  if (f !== 0) {
    writer.writeInt32(
 ...
 * @return {number}
 */
proto.palm.ops.router.v1.RouterIndexRouleResponse.Item.prototype.getId = function() {
  return /** @type {number} */ (jspb.Message.getFieldWithDefault(this, 1, 0));
};
...
/**
 * @param {number} value
 * @return {!proto.palm.ops.router.v1.RouterIndexRouleResponse.Item} returns this
 */
proto.palm.ops.router.v1.RouterIndexRouleResponse.Item.prototype.setId = function(value) {
  return jspb.Message.setProto3IntField(this, 1, value);
};
 ...
 */
proto.palm.ops.router.v1.RouterIndexRouleResponse.Item.prototype.getRule = function() {
  return /** @type{?proto.palm.ops.router.v1.Rule} */ (
    jspb.Message.getWrapperField(this, proto.palm.ops.router.v1.Rule, 2));
};


/**
 * @param {?proto.palm.ops.router.v1.Rule|undefined} value
 * @return {!proto.palm.ops.router.v1.RouterIndexRouleResponse.Item} returns this
*/
proto.palm.ops.router.v1.RouterIndexRouleResponse.Item.prototype.setRule = function(value) {
 ...
 * @return {!proto.palm.ops.router.v1.RouterIndexRouleResponse.Item} returns this
 */
proto.palm.ops.router.v1.RouterIndexRouleResponse.Item.prototype.clearRule = function() {
 ...
 * @return {boolean}
 */
proto.palm.ops.router.v1.RouterIndexRouleResponse.Item.prototype.hasRule = function() {
 ...
 * @return {!Array<!proto.palm.ops.router.v1.RouterIndexRouleResponse.Item>}
 */
proto.palm.ops.router.v1.RouterIndexRouleResponse.prototype.getItemsList = function() {
  return /** @type{!Array<!proto.palm.ops.router.v1.RouterIndexRouleResponse.Item>} */ (
    jspb.Message.getRepeatedWrapperField(this, proto.palm.ops.router.v1.RouterIndexRouleResponse.Item, 1));
};


/**
 * @param {!Array<!proto.palm.ops.router.v1.RouterIndexRouleResponse.Item>} value
 * @return {!proto.palm.ops.router.v1.RouterIndexRouleResponse} returns this
*/
proto.palm.ops.router.v1.RouterIndexRouleResponse.prototype.setItemsList = function(value) {
  return jspb.Message.setRepeatedWrapperField(this, 1, value);
};


/**
 * @param {!proto.palm.ops.router.v1.RouterIndexRouleResponse.Item=} opt_value
 * @param {number=} opt_index
 * @return {!proto.palm.ops.router.v1.RouterIndexRouleResponse.Item}
 */
proto.palm.ops.router.v1.RouterIndexRouleResponse.prototype.addItems = function(opt_value, opt_index) {
  return jspb.Message.addToRepeatedWrapperField(this, 1, opt_value, proto.palm.ops.router.v1.RouterIndexRouleResponse.Item, opt_index);
};
 ...
 * @return {!proto.palm.ops.router.v1.RouterIndexRouleResponse} returns this
 */
proto.palm.ops.router.v1.RouterIndexRouleResponse.prototype.clearItemsList = function() {
...
proto.palm.ops.router.v1.Lan.toObject = function(includeInstance, msg) {
  var f, obj = {
    ...
    cidr: jspb.Message.getFieldWithDefault(msg, 3, 0)
  };
 ...
 * @return {string}
 */
proto.palm.ops.router.v1.Lan.prototype.getNetwork = function() {
  return /** @type {string} */ (jspb.Message.getFieldWithDefault(this, 2, ""));
};
 ...
 * @return {!proto.palm.ops.router.v1.Lan} returns this
 */
proto.palm.ops.router.v1.Lan.prototype.setNetwork = function(value) {
  return jspb.Message.setProto3StringField(this, 2, value);
};


/**
 * optional uint32 cidr = 3;
 * @return {number}
 */
proto.palm.ops.router.v1.Lan.prototype.getCidr = function() {
  return /** @type {number} */ (jspb.Message.getFieldWithDefault(this, 3, 0));
};
 ...
 * @return {!proto.palm.ops.router.v1.Lan} returns this
 */
proto.palm.ops.router.v1.Lan.prototype.setCidr = function(value) {
  return jspb.Message.setProto3IntField(this, 3, value);
};
...
proto.palm.ops.router.v1.Wan.toObject = function(includeInstance, msg) {
  var f, obj = {
    ...
    ip: (f = msg.getIp()) && proto.palm.ops.router.v1.Ip.toObject(includeInstance, f)
  };
...
proto.palm.ops.router.v1.Wan.deserializeBinaryFromReader = function(msg, reader) {
  while (reader.nextField()) {
    ...
    case 11:
      ...
      break;
    case 12:
      var value = new proto.palm.ops.router.v1.Ip;
      reader.readMessage(value,proto.palm.ops.router.v1.Ip.deserializeBinaryFromReader);
      msg.setIp(value);
      break;
    default:
      reader.skipField();
...
proto.palm.ops.router.v1.Wan.serializeBinaryToWriter = function(message, writer) {
  ...
  if (f != null) {
    writer.writeMessage(
      12,
      f,
      proto.palm.ops.router.v1.Ip.serializeBinaryToWriter
    );
  }
};
...
/**
 * optional Ip ip = 12;
 * @return {?proto.palm.ops.router.v1.Ip}
 */
proto.palm.ops.router.v1.Wan.prototype.getIp = function() {
  return /** @type{?proto.palm.ops.router.v1.Ip} */ (
    jspb.Message.getWrapperField(this, proto.palm.ops.router.v1.Ip, 12));
};


/**
 * @param {?proto.palm.ops.router.v1.Ip|undefined} value
 * @return {!proto.palm.ops.router.v1.Wan} returns this
*/
proto.palm.ops.router.v1.Wan.prototype.setIp = function(value) {
  return jspb.Message.setWrapperField(this, 12, value);
};
 ...
 * @return {!proto.palm.ops.router.v1.Wan} returns this
 */
proto.palm.ops.router.v1.Wan.prototype.clearIp = function() {
 ...
 * @return {boolean}
 */
proto.palm.ops.router.v1.Wan.prototype.hasIp = function() {
  return jspb.Message.getField(this, 12) != null;
};
 ...
 * @const
 */
proto.palm.ops.router.v1.Ip.oneofGroups_ = [[11,12]];

/**
 * @enum {number}
 */
proto.palm.ops.router.v1.Ip.V4Case = {
  V4_NOT_SET: 0,
  DHCP: 11,
  STATIC: 12
};
...
/**
 * @return {proto.palm.ops.router.v1.Ip.V4Case}
 */
proto.palm.ops.router.v1.Ip.prototype.getV4Case = function() {
  return /** @type {proto.palm.ops.router.v1.Ip.V4Case} */(jspb.Message.computeOneofCase(this, proto.palm.ops.router.v1.Ip.oneofGroups_[0]));
};
 ...
 * @return {!Object}
 */
proto.palm.ops.router.v1.Ip.prototype.toObject = function(opt_includeInstance) {
  return proto.palm.ops.router.v1.Ip.toObject(opt_includeInstance, this);
};
 ...
 *     the JSPB instance for transitional soy proto support:
 *     http://goto/soy-param-migration
 * @param {!proto.palm.ops.router.v1.Ip} msg The msg instance to transform.
 * @return {!Object}
 * @suppress {unusedLocalVariables} f is only used for nested messages
 */
proto.palm.ops.router.v1.Ip.toObject = function(includeInstance, msg) {
  var f, obj = {
    dhcp: (f = msg.getDhcp()) && proto.palm.ops.router.v1.Ip.Dhcp.toObject(includeInstance, f),
    pb_static: (f = msg.getStatic()) && proto.palm.ops.router.v1.Ip.Static.toObject(includeInstance, f)
  };
 ...
 * @return {!proto.palm.ops.router.v1.Ip}
 */
proto.palm.ops.router.v1.Ip.deserializeBinary = function(bytes) {
  var reader = new jspb.BinaryReader(bytes);
  var msg = new proto.palm.ops.router.v1.Ip;
  return proto.palm.ops.router.v1.Ip.deserializeBinaryFromReader(msg, reader);
};
 ...
 * Deserializes binary data (in protobuf wire format) from the
 * given reader into the given message object.
 * @param {!proto.palm.ops.router.v1.Ip} msg The message object to deserialize into.
 * @param {!jspb.BinaryReader} reader The BinaryReader to use.
 * @return {!proto.palm.ops.router.v1.Ip}
 */
proto.palm.ops.router.v1.Ip.deserializeBinaryFromReader = function(msg, reader) {
  while (reader.nextField()) {
    if (reader.isEndGroup()) {
      break;
    }
    ...
    switch (field) {
    case 11:
      var value = new proto.palm.ops.router.v1.Ip.Dhcp;
      reader.readMessage(value,proto.palm.ops.router.v1.Ip.Dhcp.deserializeBinaryFromReader);
      msg.setDhcp(value);
      break;
    case 12:
      var value = new proto.palm.ops.router.v1.Ip.Static;
      reader.readMessage(value,proto.palm.ops.router.v1.Ip.Static.deserializeBinaryFromReader);
      msg.setStatic(value);
      break;
    default:
      reader.skipField();
 ...
 * @return {!Uint8Array}
 */
proto.palm.ops.router.v1.Ip.prototype.serializeBinary = function() {
  var writer = new jspb.BinaryWriter();
  proto.palm.ops.router.v1.Ip.serializeBinaryToWriter(this, writer);
  return writer.getResultBuffer();
};
 ...
 * Serializes the given message to binary data (in protobuf wire
 * format), writing to the given BinaryWriter.
 * @param {!proto.palm.ops.router.v1.Ip} message
 * @param {!jspb.BinaryWriter} writer
 * @suppress {unusedLocalVariables} f is only used for nested messages
 */
proto.palm.ops.router.v1.Ip.serializeBinaryToWriter = function(message, writer) {
  var f = undefined;
  f = message.getDhcp();
  if (f != null) {
    writer.writeMessage(
      11,
      f,
      proto.palm.ops.router.v1.Ip.Dhcp.serializeBinaryToWriter
    );
  }
  f = message.getStatic();
  if (f != null) {
    writer.writeMessage(
      12,
      f,
      proto.palm.ops.router.v1.Ip.Static.serializeBinaryToWriter
    );
  }
};
 ...
 * @return {!Object}
 */
proto.palm.ops.router.v1.Ip.Dhcp.prototype.toObject = function(opt_includeInstance) {
  return proto.palm.ops.router.v1.Ip.Dhcp.toObject(opt_includeInstance, this);
};
 ...
 *     the JSPB instance for transitional soy proto support:
 *     http://goto/soy-param-migration
 * @param {!proto.palm.ops.router.v1.Ip.Dhcp} msg The msg instance to transform.
 * @return {!Object}
 * @suppress {unusedLocalVariables} f is only used for nested messages
 */
proto.palm.ops.router.v1.Ip.Dhcp.toObject = function(includeInstance, msg) {
  var f, obj = {
 ...
 * Deserializes binary data (in protobuf wire format).
 * @param {jspb.ByteSource} bytes The bytes to deserialize.
 * @return {!proto.palm.ops.router.v1.Ip.Dhcp}
 */
proto.palm.ops.router.v1.Ip.Dhcp.deserializeBinary = function(bytes) {
  var reader = new jspb.BinaryReader(bytes);
  var msg = new proto.palm.ops.router.v1.Ip.Dhcp;
  return proto.palm.ops.router.v1.Ip.Dhcp.deserializeBinaryFromReader(msg, reader);
};
 ...
 * Deserializes binary data (in protobuf wire format) from the
 * given reader into the given message object.
 * @param {!proto.palm.ops.router.v1.Ip.Dhcp} msg The message object to deserialize into.
 * @param {!jspb.BinaryReader} reader The BinaryReader to use.
 * @return {!proto.palm.ops.router.v1.Ip.Dhcp}
 */
proto.palm.ops.router.v1.Ip.Dhcp.deserializeBinaryFromReader = function(msg, reader) {
  while (reader.nextField()) {
    if (reader.isEndGroup()) {
      break;
    }
 ...
 * @return {!Uint8Array}
 */
proto.palm.ops.router.v1.Ip.Dhcp.prototype.serializeBinary = function() {
  var writer = new jspb.BinaryWriter();
  proto.palm.ops.router.v1.Ip.Dhcp.serializeBinaryToWriter(this, writer);
  return writer.getResultBuffer();
};
 ...
 * Serializes the given message to binary data (in protobuf wire
 * format), writing to the given BinaryWriter.
 * @param {!proto.palm.ops.router.v1.Ip.Dhcp} message
 * @param {!jspb.BinaryWriter} writer
 * @suppress {unusedLocalVariables} f is only used for nested messages
 */
proto.palm.ops.router.v1.Ip.Dhcp.serializeBinaryToWriter = function(message, writer) {
  var f = undefined;
};
 ...
 * @return {!Object}
 */
proto.palm.ops.router.v1.Ip.Static.prototype.toObject = function(opt_includeInstance) {
  return proto.palm.ops.router.v1.Ip.Static.toObject(opt_includeInstance, this);
};
 ...
 *     the JSPB instance for transitional soy proto support:
 *     http://goto/soy-param-migration
 * @param {!proto.palm.ops.router.v1.Ip.Static} msg The msg instance to transform.
 * @return {!Object}
 * @suppress {unusedLocalVariables} f is only used for nested messages
 */
proto.palm.ops.router.v1.Ip.Static.toObject = function(includeInstance, msg) {
  var f, obj = {
 ...
 * Deserializes binary data (in protobuf wire format).
 * @param {jspb.ByteSource} bytes The bytes to deserialize.
 * @return {!proto.palm.ops.router.v1.Ip.Static}
 */
proto.palm.ops.router.v1.Ip.Static.deserializeBinary = function(bytes) {
  var reader = new jspb.BinaryReader(bytes);
  var msg = new proto.palm.ops.router.v1.Ip.Static;
  return proto.palm.ops.router.v1.Ip.Static.deserializeBinaryFromReader(msg, reader);
};
 ...
 * Deserializes binary data (in protobuf wire format) from the
 * given reader into the given message object.
 * @param {!proto.palm.ops.router.v1.Ip.Static} msg The message object to deserialize into.
 * @param {!jspb.BinaryReader} reader The BinaryReader to use.
 * @return {!proto.palm.ops.router.v1.Ip.Static}
 */
proto.palm.ops.router.v1.Ip.Static.deserializeBinaryFromReader = function(msg, reader) {
  while (reader.nextField()) {
    if (reader.isEndGroup()) {
      break;
    }
 ...
 * @return {!Uint8Array}
 */
proto.palm.ops.router.v1.Ip.Static.prototype.serializeBinary = function() {
  var writer = new jspb.BinaryWriter();
  proto.palm.ops.router.v1.Ip.Static.serializeBinaryToWriter(this, writer);
  return writer.getResultBuffer();
};
 ...
 * Serializes the given message to binary data (in protobuf wire
 * format), writing to the given BinaryWriter.
 * @param {!proto.palm.ops.router.v1.Ip.Static} message
 * @param {!jspb.BinaryWriter} writer
 * @suppress {unusedLocalVariables} f is only used for nested messages
 */
proto.palm.ops.router.v1.Ip.Static.serializeBinaryToWriter = function(message, writer) {
  var f = undefined;
  f = message.getAddress();
  if (f.length > 0) {
    writer.writeString(
 ...
 * @return {string}
 */
proto.palm.ops.router.v1.Ip.Static.prototype.getAddress = function() {
  return /** @type {string} */ (jspb.Message.getFieldWithDefault(this, 1, ""));
};
...
/**
 * @param {string} value
 * @return {!proto.palm.ops.router.v1.Ip.Static} returns this
 */
proto.palm.ops.router.v1.Ip.Static.prototype.setAddress = function(value) {
  return jspb.Message.setProto3StringField(this, 1, value);
};
 ...
 * @return {string}
 */
proto.palm.ops.router.v1.Ip.Static.prototype.getNetmask = function() {
  return /** @type {string} */ (jspb.Message.getFieldWithDefault(this, 2, ""));
};
 ...
 * @return {!proto.palm.ops.router.v1.Ip.Static} returns this
 */
proto.palm.ops.router.v1.Ip.Static.prototype.setNetmask = function(value) {
  return jspb.Message.setProto3StringField(this, 2, value);
};
 ...
 * @return {string}
 */
proto.palm.ops.router.v1.Ip.Static.prototype.getGateway = function() {
  return /** @type {string} */ (jspb.Message.getFieldWithDefault(this, 3, ""));
};
 ...
 * @return {!proto.palm.ops.router.v1.Ip.Static} returns this
 */
proto.palm.ops.router.v1.Ip.Static.prototype.setGateway = function(value) {
  return jspb.Message.setProto3StringField(this, 3, value);
};
 ...
 * @return {string}
 */
proto.palm.ops.router.v1.Ip.Static.prototype.getDns1 = function() {
  return /** @type {string} */ (jspb.Message.getFieldWithDefault(this, 4, ""));
};
 ...
 * @return {!proto.palm.ops.router.v1.Ip.Static} returns this
 */
proto.palm.ops.router.v1.Ip.Static.prototype.setDns1 = function(value) {
  return jspb.Message.setProto3StringField(this, 4, value);
};
 ...
 * @return {string}
 */
proto.palm.ops.router.v1.Ip.Static.prototype.getDns2 = function() {
 ...
 * @return {!proto.palm.ops.router.v1.Ip.Static} returns this
 */
proto.palm.ops.router.v1.Ip.Static.prototype.setDns2 = function(value) {
 ...
 * @return {!proto.palm.ops.router.v1.Ip.Static} returns this
 */
proto.palm.ops.router.v1.Ip.Static.prototype.clearDns2 = function() {
 ...
 * @return {boolean}
 */
proto.palm.ops.router.v1.Ip.Static.prototype.hasDns2 = function() {
 ...
 * @return {?proto.palm.ops.router.v1.Ip.Dhcp}
 */
proto.palm.ops.router.v1.Ip.prototype.getDhcp = function() {
  return /** @type{?proto.palm.ops.router.v1.Ip.Dhcp} */ (
    jspb.Message.getWrapperField(this, proto.palm.ops.router.v1.Ip.Dhcp, 11));
};


/**
 * @param {?proto.palm.ops.router.v1.Ip.Dhcp|undefined} value
 * @return {!proto.palm.ops.router.v1.Ip} returns this
*/
proto.palm.ops.router.v1.Ip.prototype.setDhcp = function(value) {
  return jspb.Message.setOneofWrapperField(this, 11, proto.palm.ops.router.v1.Ip.oneofGroups_[0], value);
};
 ...
 * @return {!proto.palm.ops.router.v1.Ip} returns this
 */
proto.palm.ops.router.v1.Ip.prototype.clearDhcp = function() {
 ...
 * @return {boolean}
 */
proto.palm.ops.router.v1.Ip.prototype.hasDhcp = function() {
  return jspb.Message.getField(this, 11) != null;
};
 ...
 * @return {?proto.palm.ops.router.v1.Ip.Static}
 */
proto.palm.ops.router.v1.Ip.prototype.getStatic = function() {
  return /** @type{?proto.palm.ops.router.v1.Ip.Static} */ (
    jspb.Message.getWrapperField(this, proto.palm.ops.router.v1.Ip.Static, 12));
};


/**
 * @param {?proto.palm.ops.router.v1.Ip.Static|undefined} value
 * @return {!proto.palm.ops.router.v1.Ip} returns this
*/
proto.palm.ops.router.v1.Ip.prototype.setStatic = function(value) {
  return jspb.Message.setOneofWrapperField(this, 12, proto.palm.ops.router.v1.Ip.oneofGroups_[0], value);
};
 ...
 * @return {!proto.palm.ops.router.v1.Ip} returns this
 */
proto.palm.ops.router.v1.Ip.prototype.clearStatic = function() {
 ...
 * @return {boolean}
 */
proto.palm.ops.router.v1.Ip.prototype.hasStatic = function() {
  return jspb.Message.getField(this, 12) != null;
};
