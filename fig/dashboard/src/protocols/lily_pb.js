...
goog.exportSymbol('proto.palm.lily.v1.S3FileStatusRequest', null, global);
goog.exportSymbol('proto.palm.lily.v1.S3FileStatusResponse', null, global);
goog.exportSymbol('proto.palm.lily.v1.S3FileStatusResponse.Status', null, global);
 ...
 * @constructor
 */
proto.palm.lily.v1.S3FileStatusRequest = function(opt_data) {
  jspb.Message.initialize(this, opt_data, 0, -1, null, null);
};
goog.inherits(proto.palm.lily.v1.S3FileStatusRequest, jspb.Message);
if (goog.DEBUG && !COMPILED) {
  /**
   * @public
   * @override
   */
  proto.palm.lily.v1.S3FileStatusRequest.displayName = 'proto.palm.lily.v1.S3FileStatusRequest';
}
/**
 * Generated by JsPbCodeGenerator.
 * @param {Array=} opt_data Optional initial data array, typically from a
 ...
 * @constructor
 */
proto.palm.lily.v1.S3FileStatusResponse = function(opt_data) {
  jspb.Message.initialize(this, opt_data, 0, -1, null, null);
};
goog.inherits(proto.palm.lily.v1.S3FileStatusResponse, jspb.Message);
if (goog.DEBUG && !COMPILED) {
  /**
   * @public
   * @override
   */
  proto.palm.lily.v1.S3FileStatusResponse.displayName = 'proto.palm.lily.v1.S3FileStatusResponse';
}
/**
 * Generated by JsPbCodeGenerator.
 * @param {Array=} opt_data Optional initial data array, typically from a
 ...
 * @return {!Object}
 */
proto.palm.lily.v1.S3FileStatusRequest.prototype.toObject = function(opt_includeInstance) {
  return proto.palm.lily.v1.S3FileStatusRequest.toObject(opt_includeInstance, this);
};
 ...
 *     the JSPB instance for transitional soy proto support:
 *     http://goto/soy-param-migration
 * @param {!proto.palm.lily.v1.S3FileStatusRequest} msg The msg instance to transform.
 * @return {!Object}
 * @suppress {unusedLocalVariables} f is only used for nested messages
 */
proto.palm.lily.v1.S3FileStatusRequest.toObject = function(includeInstance, msg) {
  var f, obj = {
    bucket: jspb.Message.getFieldWithDefault(msg, 1, ""),
    name: jspb.Message.getFieldWithDefault(msg, 2, "")
  };
 ...
 * Deserializes binary data (in protobuf wire format).
 * @param {jspb.ByteSource} bytes The bytes to deserialize.
 * @return {!proto.palm.lily.v1.S3FileStatusRequest}
 */
proto.palm.lily.v1.S3FileStatusRequest.deserializeBinary = function(bytes) {
  var reader = new jspb.BinaryReader(bytes);
  var msg = new proto.palm.lily.v1.S3FileStatusRequest;
  return proto.palm.lily.v1.S3FileStatusRequest.deserializeBinaryFromReader(msg, reader);
};
 ...
 * Deserializes binary data (in protobuf wire format) from the
 * given reader into the given message object.
 * @param {!proto.palm.lily.v1.S3FileStatusRequest} msg The message object to deserialize into.
 * @param {!jspb.BinaryReader} reader The BinaryReader to use.
 * @return {!proto.palm.lily.v1.S3FileStatusRequest}
 */
proto.palm.lily.v1.S3FileStatusRequest.deserializeBinaryFromReader = function(msg, reader) {
  while (reader.nextField()) {
    if (reader.isEndGroup()) {
      break;
    }
 ...
 * @return {!Uint8Array}
 */
proto.palm.lily.v1.S3FileStatusRequest.prototype.serializeBinary = function() {
  var writer = new jspb.BinaryWriter();
  proto.palm.lily.v1.S3FileStatusRequest.serializeBinaryToWriter(this, writer);
  return writer.getResultBuffer();
};
 ...
 * Serializes the given message to binary data (in protobuf wire
 * format), writing to the given BinaryWriter.
 * @param {!proto.palm.lily.v1.S3FileStatusRequest} message
 * @param {!jspb.BinaryWriter} writer
 * @suppress {unusedLocalVariables} f is only used for nested messages
 */
proto.palm.lily.v1.S3FileStatusRequest.serializeBinaryToWriter = function(message, writer) {
  var f = undefined;
  f = message.getBucket();
  if (f.length > 0) {
    writer.writeString(
 ...
 * @return {string}
 */
proto.palm.lily.v1.S3FileStatusRequest.prototype.getBucket = function() {
  return /** @type {string} */ (jspb.Message.getFieldWithDefault(this, 1, ""));
};
...
/**
 * @param {string} value
 * @return {!proto.palm.lily.v1.S3FileStatusRequest} returns this
 */
proto.palm.lily.v1.S3FileStatusRequest.prototype.setBucket = function(value) {
  return jspb.Message.setProto3StringField(this, 1, value);
};
 ...
 * @return {string}
 */
proto.palm.lily.v1.S3FileStatusRequest.prototype.getName = function() {
  return /** @type {string} */ (jspb.Message.getFieldWithDefault(this, 2, ""));
};
 ...
 * @return {!proto.palm.lily.v1.S3FileStatusRequest} returns this
 */
proto.palm.lily.v1.S3FileStatusRequest.prototype.setName = function(value) {
  return jspb.Message.setProto3StringField(this, 2, value);
};
 ...
 * @return {!Object}
 */
proto.palm.lily.v1.S3FileStatusResponse.prototype.toObject = function(opt_includeInstance) {
  return proto.palm.lily.v1.S3FileStatusResponse.toObject(opt_includeInstance, this);
};
 ...
 *     the JSPB instance for transitional soy proto support:
 *     http://goto/soy-param-migration
 * @param {!proto.palm.lily.v1.S3FileStatusResponse} msg The msg instance to transform.
 * @return {!Object}
 * @suppress {unusedLocalVariables} f is only used for nested messages
 */
proto.palm.lily.v1.S3FileStatusResponse.toObject = function(includeInstance, msg) {
  var f, obj = {
 ...
 * Deserializes binary data (in protobuf wire format).
 * @param {jspb.ByteSource} bytes The bytes to deserialize.
 * @return {!proto.palm.lily.v1.S3FileStatusResponse}
 */
proto.palm.lily.v1.S3FileStatusResponse.deserializeBinary = function(bytes) {
  var reader = new jspb.BinaryReader(bytes);
  var msg = new proto.palm.lily.v1.S3FileStatusResponse;
  return proto.palm.lily.v1.S3FileStatusResponse.deserializeBinaryFromReader(msg, reader);
};
 ...
 * Deserializes binary data (in protobuf wire format) from the
 * given reader into the given message object.
 * @param {!proto.palm.lily.v1.S3FileStatusResponse} msg The message object to deserialize into.
 * @param {!jspb.BinaryReader} reader The BinaryReader to use.
 * @return {!proto.palm.lily.v1.S3FileStatusResponse}
 */
proto.palm.lily.v1.S3FileStatusResponse.deserializeBinaryFromReader = function(msg, reader) {
  while (reader.nextField()) {
    if (reader.isEndGroup()) {
      break;
    }
    ...
    switch (field) {
    case 1:
      var value = /** @type {!proto.palm.lily.v1.S3FileStatusResponse.Status} */ (reader.readEnum());
      msg.setStatus(value);
      break;
    default:
      reader.skipField();
 ...
 * @return {!Uint8Array}
 */
proto.palm.lily.v1.S3FileStatusResponse.prototype.serializeBinary = function() {
  var writer = new jspb.BinaryWriter();
  proto.palm.lily.v1.S3FileStatusResponse.serializeBinaryToWriter(this, writer);
  return writer.getResultBuffer();
};
 ...
 * Serializes the given message to binary data (in protobuf wire
 * format), writing to the given BinaryWriter.
 * @param {!proto.palm.lily.v1.S3FileStatusResponse} message
 * @param {!jspb.BinaryWriter} writer
 * @suppress {unusedLocalVariables} f is only used for nested messages
 */
proto.palm.lily.v1.S3FileStatusResponse.serializeBinaryToWriter = function(message, writer) {
  var f = undefined;
  f = message.getStatus();
  if (f !== 0.0) {
    writer.writeEnum(
 ...
 * @enum {number}
 */
proto.palm.lily.v1.S3FileStatusResponse.Status = {
  PENDING: 0,
  SUCCESSED: 1,
  FAILED: 99
};
 ...
 * @return {!proto.palm.lily.v1.S3FileStatusResponse.Status}
 */
proto.palm.lily.v1.S3FileStatusResponse.prototype.getStatus = function() {
  return /** @type {!proto.palm.lily.v1.S3FileStatusResponse.Status} */ (jspb.Message.getFieldWithDefault(this, 1, 0));
};


/**
 * @param {!proto.palm.lily.v1.S3FileStatusResponse.Status} value
 * @return {!proto.palm.lily.v1.S3FileStatusResponse} returns this
 */
proto.palm.lily.v1.S3FileStatusResponse.prototype.setStatus = function(value) {
