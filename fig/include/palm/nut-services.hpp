...
//       std::shared_ptr<palm::redis::Pool> redis, std::shared_ptr<palm::Jwt>
//       jwt) : _postgresql(postgresql), _redis(redis), _jwt(jwt) {}
//   grpc::Status Create(grpc::ServerContext* context,
...
//        std::shared_ptr<palm::redis::Pool> redis, std::shared_ptr<palm::Jwt>
//        jwt, std::shared_ptr<palm::SecretBox> secret_box,
...
//                                   const v1::SiteMaintenanceModeRequest*
...
//                                const v1::PolicyAddRolesForUserRequest*
//                                request, google::protobuf::Empty* response)
//                                override;
...
//   grpc::Status Show(grpc::ServerContext* context, const v1::IdRequest*
//   request,
...
//                       const v1::IdRequest* request,
//                       google::protobuf::Empty* response) override;
//   grpc::Status Lock(grpc::ServerContext* context, const v1::IdRequest*
//   request,
//                     google::protobuf::Empty* response) override;
...
//       soci::session& db, const std::optional<palm::nut::dao::user::Item>
//       user, const google::protobuf::Duration* ttl,
...
// std::shared_ptr<palm::Minio> open(const palm::nut::v1::MinioProfile&
// profile); std::shared_ptr<palm::twilio::Config> open(
