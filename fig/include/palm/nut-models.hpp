...
// void create(soci::session& db, const std::string& lang, const std::string&
// code,
...
// void create(soci::session& db, const std::string& code, const int32_t
// parent); void update(soci::session& db, const int32_t id, const std::string&
// code); void destroy(soci::session& db, const int32_t id); std::vector<Item>
// get(soci::session& db); std::vector<Item> offsprings(soci::session& db, const
// int32_t id); std::vector<Item> parents(soci::session& db, const int32_t id);
// std::optional<Item> get(soci::session& db, const int32_t id);
...
// void create(soci::session& db, const std::string& code, const int32_t
// priority); void update(soci::session& db, const int32_t id, const
// std::string& code,
...
// inline void set(soci::session& db, const std::string& key, const int32_t
// user,
...
// std::optional<Item> by_nickname(soci::session& db, const std::string
// nickname); std::optional<Item> by_provider(soci::session& db,
...
// void sign_in(soci::session& db, const int32_t id, const std::string&
// client_ip); }  // namespace user
...
//     } else {
//       BOOST_LOG_TRIVIAL(error) << "unknown subject type " <<
//       this->subject_type;
//     }
//     {
...
//                         const int32_t subject_id, const std::string&
//                         operation, const std::string& resource_type, const
//                         int32_t resource_id);
// std::optional<Item> get(soci::session& db, const std::string& subject_type,
//                         const int32_t subject_id, const std::string&
//                         operation, const std::string& resource_type);
// template <class S>
...
// }
// std::vector<Item> by_subject(soci::session& db, const std::string&
// subject_type,
...
// namespace baidu {
// std::string ping_request_body(const std::string& home, const std::string&
// lang,
...
//     o.resource_type =
//     v.get<std::string>(palm::nut::dao::RESOURCE_TYPE_COLUMN);
//     {
//       const auto it =
