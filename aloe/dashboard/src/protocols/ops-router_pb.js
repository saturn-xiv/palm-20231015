 ...
 * @const
 */
proto.palm.ops.router.v1.RouterStatusResponse.repeatedFields_ = [11,21,22];
...
proto.palm.ops.router.v1.RouterStatusResponse.prototype.getIp = function() {
  return /** @type{?proto.palm.ops.router.v1.RouterStatusResponse.Ip} */ (
    jspb.Message.getWrapperField(this, proto.palm.ops.router.v1.RouterStatusResponse.Ip, 4));
};
