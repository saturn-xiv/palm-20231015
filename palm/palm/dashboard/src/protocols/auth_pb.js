...
goog.exportSymbol('proto.palm.auth.v1.Permission.Resource', null, global);
goog.exportSymbol('proto.palm.auth.v1.Permission.SubjectCase', null, global);
...
proto.palm.auth.v1.Permission = function(opt_data) {
  jspb.Message.initialize(this, opt_data, 0, -1, null, proto.palm.auth.v1.Permission.oneofGroups_);
};
 ...
 * @constructor
 */
proto.palm.auth.v1.Permission.Resource = function(opt_data) {
  jspb.Message.initialize(this, opt_data, 0, -1, null, null);
};
goog.inherits(proto.palm.auth.v1.Permission.Resource, jspb.Message);
if (goog.DEBUG && !COMPILED) {
  /**
   * @public
   * @override
   */
  proto.palm.auth.v1.Permission.Resource.displayName = 'proto.palm.auth.v1.Permission.Resource';
}
/**
 * Generated by JsPbCodeGenerator.
 * @param {Array=} opt_data Optional initial data array, typically from a
 ...
 * @const
 */
proto.palm.auth.v1.Permission.oneofGroups_ = [[11,12]];

/**
 * @enum {number}
 */
proto.palm.auth.v1.Permission.SubjectCase = {
  SUBJECT_NOT_SET: 0,
  USER: 11,
  ROLE: 12
};
...
/**
 * @return {proto.palm.auth.v1.Permission.SubjectCase}
 */
proto.palm.auth.v1.Permission.prototype.getSubjectCase = function() {
  return /** @type {proto.palm.auth.v1.Permission.SubjectCase} */(jspb.Message.computeOneofCase(this, proto.palm.auth.v1.Permission.oneofGroups_[0]));
};
...
proto.palm.auth.v1.Permission.toObject = function(includeInstance, msg) {
  var f, obj = {
    object: (f = msg.getObject()) && proto.palm.auth.v1.Permission.Resource.toObject(includeInstance, f),
...
proto.palm.auth.v1.Permission.deserializeBinaryFromReader = function(msg, reader) {
  while (reader.nextField()) {
    ...
    switch (field) {
    case 1:
      var value = new proto.palm.auth.v1.Permission.Resource;
      reader.readMessage(value,proto.palm.auth.v1.Permission.Resource.deserializeBinaryFromReader);
      msg.setObject(value);
      break;
    case 2:
      var value = /** @type {string} */ (reader.readString());
...
proto.palm.auth.v1.Permission.serializeBinaryToWriter = function(message, writer) {
  ...
  if (f != null) {
    writer.writeMessage(
      1,
      f,
      proto.palm.auth.v1.Permission.Resource.serializeBinaryToWriter
    );
  }
  f = message.getAction();
  if (f.length > 0) {
 ...
 * @return {!Object}
 */
proto.palm.auth.v1.Permission.Resource.prototype.toObject = function(opt_includeInstance) {
  return proto.palm.auth.v1.Permission.Resource.toObject(opt_includeInstance, this);
};
 ...
 *     the JSPB instance for transitional soy proto support:
 *     http://goto/soy-param-migration
 * @param {!proto.palm.auth.v1.Permission.Resource} msg The msg instance to transform.
 * @return {!Object}
 * @suppress {unusedLocalVariables} f is only used for nested messages
 */
proto.palm.auth.v1.Permission.Resource.toObject = function(includeInstance, msg) {
  var f, obj = {
 ...
 * Deserializes binary data (in protobuf wire format).
 * @param {jspb.ByteSource} bytes The bytes to deserialize.
 * @return {!proto.palm.auth.v1.Permission.Resource}
 */
proto.palm.auth.v1.Permission.Resource.deserializeBinary = function(bytes) {
  var reader = new jspb.BinaryReader(bytes);
  var msg = new proto.palm.auth.v1.Permission.Resource;
  return proto.palm.auth.v1.Permission.Resource.deserializeBinaryFromReader(msg, reader);
};
 ...
 * Deserializes binary data (in protobuf wire format) from the
 * given reader into the given message object.
 * @param {!proto.palm.auth.v1.Permission.Resource} msg The message object to deserialize into.
 * @param {!jspb.BinaryReader} reader The BinaryReader to use.
 * @return {!proto.palm.auth.v1.Permission.Resource}
 */
proto.palm.auth.v1.Permission.Resource.deserializeBinaryFromReader = function(msg, reader) {
  while (reader.nextField()) {
    if (reader.isEndGroup()) {
      break;
    }
 ...
 * @return {!Uint8Array}
 */
proto.palm.auth.v1.Permission.Resource.prototype.serializeBinary = function() {
  var writer = new jspb.BinaryWriter();
  proto.palm.auth.v1.Permission.Resource.serializeBinaryToWriter(this, writer);
  return writer.getResultBuffer();
};
 ...
 * Serializes the given message to binary data (in protobuf wire
 * format), writing to the given BinaryWriter.
 * @param {!proto.palm.auth.v1.Permission.Resource} message
 * @param {!jspb.BinaryWriter} writer
 * @suppress {unusedLocalVariables} f is only used for nested messages
 */
proto.palm.auth.v1.Permission.Resource.serializeBinaryToWriter = function(message, writer) {
  var f = undefined;
  f = message.getType();
  if (f.length > 0) {
    writer.writeString(
 ...
 * @return {string}
 */
proto.palm.auth.v1.Permission.Resource.prototype.getType = function() {
  return /** @type {string} */ (jspb.Message.getFieldWithDefault(this, 1, ""));
};
...
/**
 * @param {string} value
 * @return {!proto.palm.auth.v1.Permission.Resource} returns this
 */
proto.palm.auth.v1.Permission.Resource.prototype.setType = function(value) {
  return jspb.Message.setProto3StringField(this, 1, value);
};
 ...
 * @return {number}
 */
proto.palm.auth.v1.Permission.Resource.prototype.getId = function() {
 ...
 * @return {!proto.palm.auth.v1.Permission.Resource} returns this
 */
proto.palm.auth.v1.Permission.Resource.prototype.setId = function(value) {
 ...
 * @return {!proto.palm.auth.v1.Permission.Resource} returns this
 */
proto.palm.auth.v1.Permission.Resource.prototype.clearId = function() {
 ...
 * @return {boolean}
 */
proto.palm.auth.v1.Permission.Resource.prototype.hasId = function() {
 ...
 * @return {?proto.palm.auth.v1.Permission.Resource}
 */
proto.palm.auth.v1.Permission.prototype.getObject = function() {
  return /** @type{?proto.palm.auth.v1.Permission.Resource} */ (
    jspb.Message.getWrapperField(this, proto.palm.auth.v1.Permission.Resource, 1));
};


/**
 * @param {?proto.palm.auth.v1.Permission.Resource|undefined} value
 * @return {!proto.palm.auth.v1.Permission} returns this
*/
proto.palm.auth.v1.Permission.prototype.setObject = function(value) {
 ...
 * @return {!proto.palm.auth.v1.Permission} returns this
 */
proto.palm.auth.v1.Permission.prototype.clearObject = function() {
 ...
 * @return {boolean}
 */
proto.palm.auth.v1.Permission.prototype.hasObject = function() {
 ...
 * @return {string}
 */
proto.palm.auth.v1.Permission.prototype.getAction = function() {
  return /** @type {string} */ (jspb.Message.getFieldWithDefault(this, 2, ""));
};
 ...
 * @return {!proto.palm.auth.v1.Permission} returns this
 */
proto.palm.auth.v1.Permission.prototype.setAction = function(value) {
  return jspb.Message.setProto3StringField(this, 2, value);
};
 ...
 * @return {number}
 */
proto.palm.auth.v1.Permission.prototype.getUser = function() {
 ...
 * @return {!proto.palm.auth.v1.Permission} returns this
 */
proto.palm.auth.v1.Permission.prototype.setUser = function(value) {
  return jspb.Message.setOneofField(this, 11, proto.palm.auth.v1.Permission.oneofGroups_[0], value);
};
 ...
 * @return {!proto.palm.auth.v1.Permission} returns this
 */
proto.palm.auth.v1.Permission.prototype.clearUser = function() {
  return jspb.Message.setOneofField(this, 11, proto.palm.auth.v1.Permission.oneofGroups_[0], undefined);
};
 ...
 * @return {boolean}
 */
proto.palm.auth.v1.Permission.prototype.hasUser = function() {
 ...
 * @return {number}
 */
proto.palm.auth.v1.Permission.prototype.getRole = function() {
 ...
 * @return {!proto.palm.auth.v1.Permission} returns this
 */
proto.palm.auth.v1.Permission.prototype.setRole = function(value) {
  return jspb.Message.setOneofField(this, 12, proto.palm.auth.v1.Permission.oneofGroups_[0], value);
};
 ...
 * @return {!proto.palm.auth.v1.Permission} returns this
 */
proto.palm.auth.v1.Permission.prototype.clearRole = function() {
  return jspb.Message.setOneofField(this, 12, proto.palm.auth.v1.Permission.oneofGroups_[0], undefined);
};
 ...
 * @return {boolean}
 */
proto.palm.auth.v1.Permission.prototype.hasRole = function() {
...
proto.palm.auth.v1.UserLogsResponse.Item.toObject = function(includeInstance, msg) {
  var f, obj = {
    ...
    resource: (f = msg.getResource()) && proto.palm.auth.v1.Permission.Resource.toObject(includeInstance, f),
...
/**
 * optional Permission.Resource resource = 6;
 * @return {?proto.palm.auth.v1.Permission.Resource}
 */
proto.palm.auth.v1.UserLogsResponse.Item.prototype.getResource = function() {
  return /** @type{?proto.palm.auth.v1.Permission.Resource} */ (
    jspb.Message.getWrapperField(this, proto.palm.auth.v1.Permission.Resource, 6));
};
