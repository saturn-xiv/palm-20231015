...
#ifndef GOOGLE_PROTOBUF_INCLUDED_morus_2eproto
#define GOOGLE_PROTOBUF_INCLUDED_morus_2eproto
...
extern const ::PROTOBUF_NAMESPACE_ID::internal::DescriptorTable descriptor_table_morus_2eproto;
namespace palm {
namespace morus {
namespace v1 {
...
PROTOBUF_NAMESPACE_OPEN
template<> ::palm::morus::v1::MarkdownToHtmlRequest* Arena::CreateMaybeMessage<::palm::morus::v1::MarkdownToHtmlRequest>(Arena*);
template<> ::palm::morus::v1::MarkdownToHtmlResponse* Arena::CreateMaybeMessage<::palm::morus::v1::MarkdownToHtmlResponse>(Arena*);
PROTOBUF_NAMESPACE_CLOSE
namespace palm {
namespace morus {
namespace v1 {
...
class MarkdownToHtmlRequest final :
    public ::PROTOBUF_NAMESPACE_ID::Message /* @@protoc_insertion_point(class_definition:palm.morus.v1.MarkdownToHtmlRequest) */ {
 public:
  ...
  static ::PROTOBUF_NAMESPACE_ID::StringPiece FullMessageName() {
    return "palm.morus.v1.MarkdownToHtmlRequest";
  }
  protected:
...
class MarkdownToHtmlResponse final :
    public ::PROTOBUF_NAMESPACE_ID::Message /* @@protoc_insertion_point(class_definition:palm.morus.v1.MarkdownToHtmlResponse) */ {
 public:
  ...
  friend class ::PROTOBUF_NAMESPACE_ID::internal::AnyMetadata;
  static ::PROTOBUF_NAMESPACE_ID::StringPiece FullMessageName() {
    return "palm.morus.v1.MarkdownToHtmlResponse";
  }
  protected:
...
inline const std::string& MarkdownToHtmlRequest::payload() const {
  // @@protoc_insertion_point(field_get:palm.morus.v1.MarkdownToHtmlRequest.payload)
  return _internal_payload();
}
template <typename ArgT0, typename... ArgT>
inline PROTOBUF_ALWAYS_INLINE
void MarkdownToHtmlRequest::set_payload(ArgT0&& arg0, ArgT... args) {
 
 _impl_.payload_.Set(static_cast<ArgT0 &&>(arg0), args..., GetArenaForAllocation());
  // @@protoc_insertion_point(field_set:palm.morus.v1.MarkdownToHtmlRequest.payload)
}
inline std::string* MarkdownToHtmlRequest::mutable_payload() {
  std::string* _s = _internal_mutable_payload();
  // @@protoc_insertion_point(field_mutable:palm.morus.v1.MarkdownToHtmlRequest.payload)
  return _s;
}
...
inline std::string* MarkdownToHtmlRequest::release_payload() {
  // @@protoc_insertion_point(field_release:palm.morus.v1.MarkdownToHtmlRequest.payload)
  return _impl_.payload_.Release();
}
inline void MarkdownToHtmlRequest::set_allocated_payload(std::string* payload) {
  if (payload != nullptr) {
...
inline const std::string& MarkdownToHtmlResponse::payload() const {
  // @@protoc_insertion_point(field_get:palm.morus.v1.MarkdownToHtmlResponse.payload)
  return _internal_payload();
}
template <typename ArgT0, typename... ArgT>
inline PROTOBUF_ALWAYS_INLINE
void MarkdownToHtmlResponse::set_payload(ArgT0&& arg0, ArgT... args) {
 
 _impl_.payload_.Set(static_cast<ArgT0 &&>(arg0), args..., GetArenaForAllocation());
  // @@protoc_insertion_point(field_set:palm.morus.v1.MarkdownToHtmlResponse.payload)
}
inline std::string* MarkdownToHtmlResponse::mutable_payload() {
  std::string* _s = _internal_mutable_payload();
  // @@protoc_insertion_point(field_mutable:palm.morus.v1.MarkdownToHtmlResponse.payload)
  return _s;
}
...
inline std::string* MarkdownToHtmlResponse::release_payload() {
  // @@protoc_insertion_point(field_release:palm.morus.v1.MarkdownToHtmlResponse.payload)
  return _impl_.payload_.Release();
}
inline void MarkdownToHtmlResponse::set_allocated_payload(std::string* payload) {
  if (payload != nullptr) {
...
#endif // PROTOBUF_FORCE_COPY_DEFAULT_STRING
  // @@protoc_insertion_point(field_set_allocated:palm.morus.v1.MarkdownToHtmlResponse.payload)
}
...
#include <google/protobuf/port_undef.inc>
#endif  // GOOGLE_PROTOBUF_INCLUDED_GOOGLE_PROTOBUF_INCLUDED_morus_2eproto
