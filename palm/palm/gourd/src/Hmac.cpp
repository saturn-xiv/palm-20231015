...
void HmacClient::sign(std::string& _return, const std::string& id, const std::string& plain)
{
  send_sign(id, plain);
  recv_sign(_return);
}

void HmacClient::send_sign(const std::string& id, const std::string& plain)
{
  int32_t cseqid = 0;
...
void HmacClient::verify(const std::string& app, const std::string& code, const std::string& plain)
{
  send_verify(app, code, plain);
  recv_verify();
}

void HmacClient::send_verify(const std::string& app, const std::string& code, const std::string& plain)
{
  int32_t cseqid = 0;
...
void HmacProcessor::process_sign(int32_t seqid, ::apache::thrift::protocol::TProtocol* iprot, ::apache::thrift::protocol::TProtocol* oprot, void* callContext)
{
  ...
  try {
    iface_->sign(result.success, args.id, args.plain);
...
void HmacProcessor::process_verify(int32_t seqid, ::apache::thrift::protocol::TProtocol* iprot, ::apache::thrift::protocol::TProtocol* oprot, void* callContext)
{
  ...
  try {
    iface_->verify(args.app, args.code, args.plain);
  } catch (const std::exception& e) {
    if (this->eventHandler_.get() != nullptr) {
...
void HmacConcurrentClient::sign(std::string& _return, const std::string& id, const std::string& plain)
{
  int32_t seqid = send_sign(id, plain);
  recv_sign(_return, seqid);
}

int32_t HmacConcurrentClient::send_sign(const std::string& id, const std::string& plain)
{
...
void HmacConcurrentClient::verify(const std::string& app, const std::string& code, const std::string& plain)
{
  int32_t seqid = send_verify(app, code, plain);
  recv_verify(seqid);
}

int32_t HmacConcurrentClient::send_verify(const std::string& app, const std::string& code, const std::string& plain)
{
  int32_t cseqid = this->sync_->generateSeqId();
  ::apache::thrift::async::TConcurrentSendSentry sentry(this->sync_.get());
  oprot_->writeMessageBegin("verify", ::apache::thrift::protocol::T_CALL, cseqid);
