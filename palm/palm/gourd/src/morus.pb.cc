...
struct MarkdownToHtmlRequestDefaultTypeInternal {
  PROTOBUF_CONSTEXPR MarkdownToHtmlRequestDefaultTypeInternal()
...
PROTOBUF_ATTRIBUTE_NO_DESTROY PROTOBUF_CONSTINIT PROTOBUF_ATTRIBUTE_INIT_PRIORITY1 MarkdownToHtmlRequestDefaultTypeInternal _MarkdownToHtmlRequest_default_instance_;
PROTOBUF_CONSTEXPR MarkdownToHtmlResponse::MarkdownToHtmlResponse(
    ::_pbi::ConstantInitialized): _impl_{
    /*decltype(_impl_.payload_)*/{&::_pbi::fixed_address_empty_string, ::_pbi::ConstantInitialized{}}
  , /*decltype(_impl_._cached_size_)*/{}} {}
struct MarkdownToHtmlResponseDefaultTypeInternal {
  PROTOBUF_CONSTEXPR MarkdownToHtmlResponseDefaultTypeInternal()
      : _instance(::_pbi::ConstantInitialized{}) {}
...
PROTOBUF_ATTRIBUTE_NO_DESTROY PROTOBUF_CONSTINIT PROTOBUF_ATTRIBUTE_INIT_PRIORITY1 MarkdownToHtmlResponseDefaultTypeInternal _MarkdownToHtmlResponse_default_instance_;
}  // namespace v1
}  // namespace morus
}  // namespace palm
static ::_pb::Metadata file_level_metadata_morus_2eproto[2];
static constexpr ::_pb::EnumDescriptor const** file_level_enum_descriptors_morus_2eproto = nullptr;
static constexpr ::_pb::ServiceDescriptor const** file_level_service_descriptors_morus_2eproto = nullptr;

const uint32_t TableStruct_morus_2eproto::offsets[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) = {
  ~0u,  // no _has_bits_
...
static const ::_pbi::MigrationSchema schemas[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) = {
  ...
  { 8, -1, -1, sizeof(::palm::morus::v1::MarkdownToHtmlResponse)},
};
...
const char descriptor_table_protodef_morus_2eproto[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) =
  ...
  "\001b\006proto3"
  ;
static ::_pbi::once_flag descriptor_table_morus_2eproto_once;
const ::_pbi::DescriptorTable descriptor_table_morus_2eproto = {
    false, false, 289, descriptor_table_protodef_morus_2eproto,
    "morus.proto",
    &descriptor_table_morus_2eproto_once, nullptr, 0, 2,
    schemas, file_default_instances, TableStruct_morus_2eproto::offsets,
    file_level_metadata_morus_2eproto, file_level_enum_descriptors_morus_2eproto,
...
PROTOBUF_ATTRIBUTE_INIT_PRIORITY2 static ::_pbi::AddDescriptorsRunner dynamic_init_dummy_morus_2eproto(&descriptor_table_morus_2eproto);
namespace palm {
namespace morus {
namespace v1 {
...
inline void MarkdownToHtmlRequest::SharedCtor(
...
uint8_t* MarkdownToHtmlRequest::_InternalSerialize(
  ...
  if (!this->_internal_payload().empty()) {
    ::PROTOBUF_NAMESPACE_ID::internal::WireFormatLite::VerifyUtf8String(
      ...
      "palm.morus.v1.MarkdownToHtmlRequest.payload");
  ...
  if (this->_internal_sanitize() != 0) {
    ...
    target = ::_pbi::WireFormatLite::WriteBoolToArray(2, this->_internal_sanitize(), target);
  }
...
inline void MarkdownToHtmlResponse::SharedCtor(
    ::_pb::Arena* arena, bool is_message_owned) {
  (void)arena;
  (void)is_message_owned;
  new (&_impl_) Impl_{
...
uint8_t* MarkdownToHtmlResponse::_InternalSerialize(
  ...
  if (!this->_internal_payload().empty()) {
    ::PROTOBUF_NAMESPACE_ID::internal::WireFormatLite::VerifyUtf8String(
      this->_internal_payload().data(), static_cast<int>(this->_internal_payload().length()),
      ::PROTOBUF_NAMESPACE_ID::internal::WireFormatLite::SERIALIZE,
      "palm.morus.v1.MarkdownToHtmlResponse.payload");
    target = stream->WriteStringMaybeAliased(
        1, this->_internal_payload(), target);
  }
