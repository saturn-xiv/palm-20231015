...
class AesIf {
 public:
  virtual ~AesIf() {}
  virtual void encrypt(std::string& _return, const std::string& auth, const std::string& plain) = 0;
  virtual void decrypt(std::string& _return, const std::string& auth, const std::string& code) = 0;
};
...
class AesNull : virtual public AesIf {
 public:
  virtual ~AesNull() {}
  void encrypt(std::string& /* _return */, const std::string& /* auth */, const std::string& /* plain */) override {
    return;
  }
  void decrypt(std::string& /* _return */, const std::string& /* auth */, const std::string& /* code */) override {
    return;
  }
};

typedef struct _Aes_encrypt_args__isset {
  _Aes_encrypt_args__isset() : auth(false), plain(false) {}
  bool auth :1;
  bool plain :1;
...
typedef struct _Aes_decrypt_args__isset {
  _Aes_decrypt_args__isset() : auth(false), code(false) {}
  bool auth :1;
  bool code :1;
...
class AesClient : virtual public AesIf {
 ...
 public:
  ...
  void encrypt(std::string& _return, const std::string& auth, const std::string& plain) override;
  void send_encrypt(const std::string& auth, const std::string& plain);
  void recv_encrypt(std::string& _return);
  void decrypt(std::string& _return, const std::string& auth, const std::string& code) override;
  void send_decrypt(const std::string& auth, const std::string& code);
...
class AesMultiface : virtual public AesIf {
 ...
 public:
  void encrypt(std::string& _return, const std::string& auth, const std::string& plain) override {
    ...
    size_t i = 0;
    for (; i < (sz - 1); ++i) {
      ifaces_[i]->encrypt(_return, auth, plain);
    }
    ifaces_[i]->encrypt(_return, auth, plain);
    return;
  }
  ...
  void decrypt(std::string& _return, const std::string& auth, const std::string& code) override {
    ...
    size_t i = 0;
    for (; i < (sz - 1); ++i) {
      ifaces_[i]->decrypt(_return, auth, code);
    }
    ifaces_[i]->decrypt(_return, auth, code);
    return;
  }
  ...
  AesConcurrentClient(std::shared_ptr< ::apache::thrift::protocol::TProtocol> iprot, std::shared_ptr< ::apache::thrift::protocol::TProtocol> oprot, std::shared_ptr< ::apache::thrift::async::TConcurrentClientSyncInfo> sync) : sync_(sync)
{
 ...
 public:
  ...
  void encrypt(std::string& _return, const std::string& auth, const std::string& plain) override;
  int32_t send_encrypt(const std::string& auth, const std::string& plain);
  void recv_encrypt(std::string& _return, const int32_t seqid);
  void decrypt(std::string& _return, const std::string& auth, const std::string& code) override;
  int32_t send_decrypt(const std::string& auth, const std::string& code);
