...
goog.exportSymbol('proto.palm.plugins.nut.v1.RbacGetRolesForUserResponse', null, global);
goog.exportSymbol('proto.palm.plugins.nut.v1.RbacGetUsersForRoleResponse', null, global);
 ...
 * @constructor
 */
proto.palm.plugins.nut.v1.RbacGetRolesForUserResponse = function(opt_data) {
  jspb.Message.initialize(this, opt_data, 0, -1, proto.palm.plugins.nut.v1.RbacGetRolesForUserResponse.repeatedFields_, null);
};
goog.inherits(proto.palm.plugins.nut.v1.RbacGetRolesForUserResponse, jspb.Message);
if (goog.DEBUG && !COMPILED) {
  /**
   * @public
   * @override
   */
  proto.palm.plugins.nut.v1.RbacGetRolesForUserResponse.displayName = 'proto.palm.plugins.nut.v1.RbacGetRolesForUserResponse';
}
/**
 * Generated by JsPbCodeGenerator.
 * @param {Array=} opt_data Optional initial data array, typically from a
 ...
 * @constructor
 */
proto.palm.plugins.nut.v1.RbacGetUsersForRoleResponse = function(opt_data) {
  jspb.Message.initialize(this, opt_data, 0, -1, proto.palm.plugins.nut.v1.RbacGetUsersForRoleResponse.repeatedFields_, null);
};
goog.inherits(proto.palm.plugins.nut.v1.RbacGetUsersForRoleResponse, jspb.Message);
if (goog.DEBUG && !COMPILED) {
  /**
   * @public
   * @override
   */
  proto.palm.plugins.nut.v1.RbacGetUsersForRoleResponse.displayName = 'proto.palm.plugins.nut.v1.RbacGetUsersForRoleResponse';
}
/**
 * Generated by JsPbCodeGenerator.
 * @param {Array=} opt_data Optional initial data array, typically from a
 ...
 * @const
 */
proto.palm.plugins.nut.v1.RbacGetRolesForUserResponse.repeatedFields_ = [1];
 ...
 * @return {!Object}
 */
proto.palm.plugins.nut.v1.RbacGetRolesForUserResponse.prototype.toObject = function(opt_includeInstance) {
  return proto.palm.plugins.nut.v1.RbacGetRolesForUserResponse.toObject(opt_includeInstance, this);
};
 ...
 *     the JSPB instance for transitional soy proto support:
 *     http://goto/soy-param-migration
 * @param {!proto.palm.plugins.nut.v1.RbacGetRolesForUserResponse} msg The msg instance to transform.
 * @return {!Object}
 * @suppress {unusedLocalVariables} f is only used for nested messages
 */
proto.palm.plugins.nut.v1.RbacGetRolesForUserResponse.toObject = function(includeInstance, msg) {
  var f, obj = {
 ...
 * Deserializes binary data (in protobuf wire format).
 * @param {jspb.ByteSource} bytes The bytes to deserialize.
 * @return {!proto.palm.plugins.nut.v1.RbacGetRolesForUserResponse}
 */
proto.palm.plugins.nut.v1.RbacGetRolesForUserResponse.deserializeBinary = function(bytes) {
  var reader = new jspb.BinaryReader(bytes);
  var msg = new proto.palm.plugins.nut.v1.RbacGetRolesForUserResponse;
  return proto.palm.plugins.nut.v1.RbacGetRolesForUserResponse.deserializeBinaryFromReader(msg, reader);
};
 ...
 * Deserializes binary data (in protobuf wire format) from the
 * given reader into the given message object.
 * @param {!proto.palm.plugins.nut.v1.RbacGetRolesForUserResponse} msg The message object to deserialize into.
 * @param {!jspb.BinaryReader} reader The BinaryReader to use.
 * @return {!proto.palm.plugins.nut.v1.RbacGetRolesForUserResponse}
 */
proto.palm.plugins.nut.v1.RbacGetRolesForUserResponse.deserializeBinaryFromReader = function(msg, reader) {
  while (reader.nextField()) {
    if (reader.isEndGroup()) {
      break;
    }
 ...
 * @return {!Uint8Array}
 */
proto.palm.plugins.nut.v1.RbacGetRolesForUserResponse.prototype.serializeBinary = function() {
  var writer = new jspb.BinaryWriter();
  proto.palm.plugins.nut.v1.RbacGetRolesForUserResponse.serializeBinaryToWriter(this, writer);
  return writer.getResultBuffer();
};
 ...
 * Serializes the given message to binary data (in protobuf wire
 * format), writing to the given BinaryWriter.
 * @param {!proto.palm.plugins.nut.v1.RbacGetRolesForUserResponse} message
 * @param {!jspb.BinaryWriter} writer
 * @suppress {unusedLocalVariables} f is only used for nested messages
 */
proto.palm.plugins.nut.v1.RbacGetRolesForUserResponse.serializeBinaryToWriter = function(message, writer) {
  var f = undefined;
  f = message.getItemsList();
  if (f.length > 0) {
    writer.writeRepeatedString(
 ...
 * @return {!Array<string>}
 */
proto.palm.plugins.nut.v1.RbacGetRolesForUserResponse.prototype.getItemsList = function() {
...
/**
 * @param {!Array<string>} value
 * @return {!proto.palm.plugins.nut.v1.RbacGetRolesForUserResponse} returns this
 */
proto.palm.plugins.nut.v1.RbacGetRolesForUserResponse.prototype.setItemsList = function(value) {
 ...
 * @return {!proto.palm.plugins.nut.v1.RbacGetRolesForUserResponse} returns this
 */
proto.palm.plugins.nut.v1.RbacGetRolesForUserResponse.prototype.addItems = function(value, opt_index) {
 ...
 * @return {!proto.palm.plugins.nut.v1.RbacGetRolesForUserResponse} returns this
 */
proto.palm.plugins.nut.v1.RbacGetRolesForUserResponse.prototype.clearItemsList = function() {
  return this.setItemsList([]);
};
 ...
 * @const
 */
proto.palm.plugins.nut.v1.RbacGetUsersForRoleResponse.repeatedFields_ = [2];
 ...
 * @return {!Object}
 */
proto.palm.plugins.nut.v1.RbacGetUsersForRoleResponse.prototype.toObject = function(opt_includeInstance) {
  return proto.palm.plugins.nut.v1.RbacGetUsersForRoleResponse.toObject(opt_includeInstance, this);
};
 ...
 *     the JSPB instance for transitional soy proto support:
 *     http://goto/soy-param-migration
 * @param {!proto.palm.plugins.nut.v1.RbacGetUsersForRoleResponse} msg The msg instance to transform.
 * @return {!Object}
 * @suppress {unusedLocalVariables} f is only used for nested messages
 */
proto.palm.plugins.nut.v1.RbacGetUsersForRoleResponse.toObject = function(includeInstance, msg) {
  var f, obj = {
 ...
 * Deserializes binary data (in protobuf wire format).
 * @param {jspb.ByteSource} bytes The bytes to deserialize.
 * @return {!proto.palm.plugins.nut.v1.RbacGetUsersForRoleResponse}
 */
proto.palm.plugins.nut.v1.RbacGetUsersForRoleResponse.deserializeBinary = function(bytes) {
  var reader = new jspb.BinaryReader(bytes);
  var msg = new proto.palm.plugins.nut.v1.RbacGetUsersForRoleResponse;
  return proto.palm.plugins.nut.v1.RbacGetUsersForRoleResponse.deserializeBinaryFromReader(msg, reader);
};
 ...
 * Deserializes binary data (in protobuf wire format) from the
 * given reader into the given message object.
 * @param {!proto.palm.plugins.nut.v1.RbacGetUsersForRoleResponse} msg The message object to deserialize into.
 * @param {!jspb.BinaryReader} reader The BinaryReader to use.
 * @return {!proto.palm.plugins.nut.v1.RbacGetUsersForRoleResponse}
 */
proto.palm.plugins.nut.v1.RbacGetUsersForRoleResponse.deserializeBinaryFromReader = function(msg, reader) {
  while (reader.nextField()) {
    if (reader.isEndGroup()) {
      break;
    }
 ...
 * @return {!Uint8Array}
 */
proto.palm.plugins.nut.v1.RbacGetUsersForRoleResponse.prototype.serializeBinary = function() {
  var writer = new jspb.BinaryWriter();
  proto.palm.plugins.nut.v1.RbacGetUsersForRoleResponse.serializeBinaryToWriter(this, writer);
  return writer.getResultBuffer();
};
 ...
 * Serializes the given message to binary data (in protobuf wire
 * format), writing to the given BinaryWriter.
 * @param {!proto.palm.plugins.nut.v1.RbacGetUsersForRoleResponse} message
 * @param {!jspb.BinaryWriter} writer
 * @suppress {unusedLocalVariables} f is only used for nested messages
 */
proto.palm.plugins.nut.v1.RbacGetUsersForRoleResponse.serializeBinaryToWriter = function(message, writer) {
  var f = undefined;
  f = message.getItemsList();
  if (f.length > 0) {
    writer.writeRepeatedString(
 ...
 * @return {!Array<string>}
 */
proto.palm.plugins.nut.v1.RbacGetUsersForRoleResponse.prototype.getItemsList = function() {
  return /** @type {!Array<string>} */ (jspb.Message.getRepeatedField(this, 2));
};
...
/**
 * @param {!Array<string>} value
 * @return {!proto.palm.plugins.nut.v1.RbacGetUsersForRoleResponse} returns this
 */
proto.palm.plugins.nut.v1.RbacGetUsersForRoleResponse.prototype.setItemsList = function(value) {
  return jspb.Message.setField(this, 2, value || []);
};
 ...
 * @return {!proto.palm.plugins.nut.v1.RbacGetUsersForRoleResponse} returns this
 */
proto.palm.plugins.nut.v1.RbacGetUsersForRoleResponse.prototype.addItems = function(value, opt_index) {
  return jspb.Message.addToRepeatedField(this, 2, value, opt_index);
};
 ...
 * @return {!proto.palm.plugins.nut.v1.RbacGetUsersForRoleResponse} returns this
 */
proto.palm.plugins.nut.v1.RbacGetUsersForRoleResponse.prototype.clearItemsList = function() {
  return this.setItemsList([]);
};
