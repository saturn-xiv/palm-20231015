const items = {
  ...
  "nut.admin.site.tabs.status": "Status",
  "nut.admin.site.tabs.seo": "SEO",
  "nut.admin.site.tabs.profile": "Profile",
  ...
  "nut.admin.site.google.site-verify-code": "Site verify site id",
  "nut.admin.site.baidu.title": "Baidu",
  "nut.admin.site.baidu.site-verify-code": "Site verify site id",
  "nut.admin.site.baidu.site-verify-content": "Site verify file content",
  "nut.admin.site.redis.title": "Redis",
  "nut.admin.site.redis.confirm-purge": "Are you sure to purge cache?",
  "nut.admin.site.postgresql.title": "PostgreSql",
  "nut.admin.site.postgresql.fields.name": "Name",
  "nut.admin.site.postgresql.fields.size": "Size(MB)",
  "nut.admin.site.postgresql.databases": "Databases",
  "nut.admin.site.rabbitmq.title": "Messaging queues",
  "nut.admin.site.system.title": "System",
