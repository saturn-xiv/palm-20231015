...
module Palm
  module Ops
    module Router
      module V1
        Config = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("palm.ops.router.v1.Config").msgclass
        Config::Dhcp = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("palm.ops.router.v1.Config.Dhcp").msgclass
        Config::StaticIp = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("palm.ops.router.v1.Config.StaticIp").msgclass
        Config::Wan = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("palm.ops.router.v1.Config.Wan").msgclass
        Config::Wan::Ethernet = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("palm.ops.router.v1.Config.Wan.Ethernet").msgclass
        Config::Dmz = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("palm.ops.router.v1.Config.Dmz").msgclass
        Config::Lan = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("palm.ops.router.v1.Config.Lan").msgclass
        Config::Guest = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("palm.ops.router.v1.Config.Guest").msgclass
