...
namespace Palm\Nut\V1\UserLogsResponse;
...
/**
 * Generated from protobuf message <code>palm.nut.v1.UserLogsResponse.Item</code>
 */
class Item extends \Google\Protobuf\Internal\Message
{
    ...
    protected $ip = '';
    /**
     * Generated from protobuf field <code>.palm.nut.v1.UserLogsResponse.Item.Level level = 4;</code>
     */
    protected $level = 0;
    /**
    ...
    {
        GPBUtil::checkEnum($var, \Palm\Nut\V1\UserLogsResponse\Item\Level::class);
        $this->level = $var;
...
class_alias(Item::class, \Palm\Nut\V1\UserLogsResponse_Item::class);
