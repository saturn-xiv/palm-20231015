...
/**
 * Generated from protobuf message <code>palm.metasequoia.v1.MediaContent</code>
 */
class MediaContent extends \Google\Protobuf\Internal\Message
{
    /**
     * Generated from protobuf field <code>.palm.metasequoia.v1.MediaContent.Editor editor = 1;</code>
     */
    protected $editor = 0;
    /**
    ...
    protected $body = '';
    /**
     * Generated from protobuf field <code>.palm.metasequoia.v1.MediaContent.Status status = 3;</code>
     */
    protected $status = 0;
    /**
    ...
    {
        GPBUtil::checkEnum($var, \Palm\Metasequoia\V1\MediaContent\Editor::class);
        $this->editor = $var;
