...
class LeaveWordClient extends \Grpc\BaseStub {
    ...
    public function Create(\Palm\Nut\V1\MediaContent $argument,
      $metadata = [], $options = []) {
        return $this->_simpleRequest('/palm.fig.v1.LeaveWord/Create',
        $argument,
    ...
    public function Index(\Palm\Nut\V1\Pager $argument,
      $metadata = [], $options = []) {
        return $this->_simpleRequest('/palm.fig.v1.LeaveWord/Index',
        $argument,
        ['\Palm\Fig\V1\LeaveWordIndexResponse', 'decode'],
        $metadata, $options);
    }
    ...
    public function Show(\Palm\Nut\V1\IdRequest $argument,
      $metadata = [], $options = []) {
        return $this->_simpleRequest('/palm.fig.v1.LeaveWord/Show',
        $argument,
        ['\Palm\Fig\V1\LeaveWordIndexResponse\Item', 'decode'],
        $metadata, $options);
    }
    ...
    public function Destroy(\Palm\Nut\V1\IdRequest $argument,
      $metadata = [], $options = []) {
        return $this->_simpleRequest('/palm.fig.v1.LeaveWord/Destroy',
        $argument,
        ['\Google\Protobuf\GPBEmpty', 'decode'],
        $metadata, $options);
    }
