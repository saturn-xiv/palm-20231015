...
/**
 * Generated from protobuf message <code>palm.fig.v1.SiteSmtpPingRequest</code>
 */
class SiteSmtpPingRequest extends \Google\Protobuf\Internal\Message
{
    ...
    protected $content = '';
    /**
     * Generated from protobuf field <code>.palm.fig.v1.SmtpProfile profile = 9;</code>
     */
     ...
     *     @type string $subject
     *     @type string $content
     *     @type \Palm\Fig\V1\SmtpProfile $profile
     * }
     */
    ...
    /**
     * Generated from protobuf field <code>.palm.fig.v1.SmtpProfile profile = 9;</code>
     * @return \Palm\Fig\V1\SmtpProfile|null
     */
    ...
    /**
     * Generated from protobuf field <code>.palm.fig.v1.SmtpProfile profile = 9;</code>
     * @param \Palm\Fig\V1\SmtpProfile $var
     * @return $this
     */
    public function setProfile($var)
    {
        GPBUtil::checkMessage($var, \Palm\Fig\V1\SmtpProfile::class);
        $this->profile = $var;
