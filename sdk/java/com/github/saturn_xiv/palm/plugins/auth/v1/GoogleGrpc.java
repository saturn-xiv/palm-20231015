...
public final class GoogleGrpc {
  ...
  public static final java.lang.String SERVICE_NAME = "palm.auth.v1.Google";

  // Static method descriptors that strictly reflect the proto.
  private static volatile io.grpc.MethodDescriptor<com.github.saturn_xiv.palm.plugins.auth.v1.GoogleSignInUrlRequest,
      com.github.saturn_xiv.palm.plugins.auth.v1.GoogleSignInUrlResponse> getSignInUrlMethod;

  @io.grpc.stub.annotations.RpcMethod(
      fullMethodName = SERVICE_NAME + '/' + "SignInUrl",
      requestType = com.github.saturn_xiv.palm.plugins.auth.v1.GoogleSignInUrlRequest.class,
      responseType = com.github.saturn_xiv.palm.plugins.auth.v1.GoogleSignInUrlResponse.class,
      methodType = io.grpc.MethodDescriptor.MethodType.UNARY)
  public static io.grpc.MethodDescriptor<com.github.saturn_xiv.palm.plugins.auth.v1.GoogleSignInUrlRequest,
      com.github.saturn_xiv.palm.plugins.auth.v1.GoogleSignInUrlResponse> getSignInUrlMethod() {
    io.grpc.MethodDescriptor<com.github.saturn_xiv.palm.plugins.auth.v1.GoogleSignInUrlRequest, com.github.saturn_xiv.palm.plugins.auth.v1.GoogleSignInUrlResponse> getSignInUrlMethod;
      ...
      synchronized (GoogleGrpc.class) {
        if ((getSignInUrlMethod = GoogleGrpc.getSignInUrlMethod) == null) {
          GoogleGrpc.getSignInUrlMethod = getSignInUrlMethod =
              io.grpc.MethodDescriptor.<com.github.saturn_xiv.palm.plugins.auth.v1.GoogleSignInUrlRequest, com.github.saturn_xiv.palm.plugins.auth.v1.GoogleSignInUrlResponse>newBuilder()
              .setType(io.grpc.MethodDescriptor.MethodType.UNARY)
              .setFullMethodName(generateFullMethodName(SERVICE_NAME, "SignInUrl"))
              .setSampledToLocalTracing(true)
              .setRequestMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  com.github.saturn_xiv.palm.plugins.auth.v1.GoogleSignInUrlRequest.getDefaultInstance()))
              .setResponseMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  com.github.saturn_xiv.palm.plugins.auth.v1.GoogleSignInUrlResponse.getDefaultInstance()))
  ...
  private static volatile io.grpc.MethodDescriptor<com.github.saturn_xiv.palm.plugins.auth.v1.SignInByGoogleRequest,
      com.github.saturn_xiv.palm.plugins.auth.v1.UserSignInResponse> getSignInMethod;

  @io.grpc.stub.annotations.RpcMethod(
      fullMethodName = SERVICE_NAME + '/' + "SignIn",
      requestType = com.github.saturn_xiv.palm.plugins.auth.v1.SignInByGoogleRequest.class,
      responseType = com.github.saturn_xiv.palm.plugins.auth.v1.UserSignInResponse.class,
      methodType = io.grpc.MethodDescriptor.MethodType.UNARY)
  public static io.grpc.MethodDescriptor<com.github.saturn_xiv.palm.plugins.auth.v1.SignInByGoogleRequest,
      com.github.saturn_xiv.palm.plugins.auth.v1.UserSignInResponse> getSignInMethod() {
    io.grpc.MethodDescriptor<com.github.saturn_xiv.palm.plugins.auth.v1.SignInByGoogleRequest, com.github.saturn_xiv.palm.plugins.auth.v1.UserSignInResponse> getSignInMethod;
    if ((getSignInMethod = GoogleGrpc.getSignInMethod) == null) {
      synchronized (GoogleGrpc.class) {
        if ((getSignInMethod = GoogleGrpc.getSignInMethod) == null) {
          GoogleGrpc.getSignInMethod = getSignInMethod =
              io.grpc.MethodDescriptor.<com.github.saturn_xiv.palm.plugins.auth.v1.SignInByGoogleRequest, com.github.saturn_xiv.palm.plugins.auth.v1.UserSignInResponse>newBuilder()
              .setType(io.grpc.MethodDescriptor.MethodType.UNARY)
              .setFullMethodName(generateFullMethodName(SERVICE_NAME, "SignIn"))
              .setSampledToLocalTracing(true)
              .setRequestMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  com.github.saturn_xiv.palm.plugins.auth.v1.SignInByGoogleRequest.getDefaultInstance()))
              .setResponseMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
  ...
  public interface AsyncService {
    ...
    /**
     */
    default void signInUrl(com.github.saturn_xiv.palm.plugins.auth.v1.GoogleSignInUrlRequest request,
        io.grpc.stub.StreamObserver<com.github.saturn_xiv.palm.plugins.auth.v1.GoogleSignInUrlResponse> responseObserver) {
      io.grpc.stub.ServerCalls.asyncUnimplementedUnaryCall(getSignInUrlMethod(), responseObserver);
    }

    /**
     */
    default void signIn(com.github.saturn_xiv.palm.plugins.auth.v1.SignInByGoogleRequest request,
  ...
  public static final class GoogleStub
    ...
    /**
     */
    public void signInUrl(com.github.saturn_xiv.palm.plugins.auth.v1.GoogleSignInUrlRequest request,
        io.grpc.stub.StreamObserver<com.github.saturn_xiv.palm.plugins.auth.v1.GoogleSignInUrlResponse> responseObserver) {
    ...
    /**
     */
    public void signIn(com.github.saturn_xiv.palm.plugins.auth.v1.SignInByGoogleRequest request,
        io.grpc.stub.StreamObserver<com.github.saturn_xiv.palm.plugins.auth.v1.UserSignInResponse> responseObserver) {
      io.grpc.stub.ClientCalls.asyncUnaryCall(
  ...
  public static final class GoogleBlockingStub
    ...
    /**
     */
    public com.github.saturn_xiv.palm.plugins.auth.v1.GoogleSignInUrlResponse signInUrl(com.github.saturn_xiv.palm.plugins.auth.v1.GoogleSignInUrlRequest request) {
    ...
    /**
     */
    public com.github.saturn_xiv.palm.plugins.auth.v1.UserSignInResponse signIn(com.github.saturn_xiv.palm.plugins.auth.v1.SignInByGoogleRequest request) {
      return io.grpc.stub.ClientCalls.blockingUnaryCall(
  ...
  public static final class GoogleFutureStub
    ...
    /**
     */
    public com.google.common.util.concurrent.ListenableFuture<com.github.saturn_xiv.palm.plugins.auth.v1.GoogleSignInUrlResponse> signInUrl(
        com.github.saturn_xiv.palm.plugins.auth.v1.GoogleSignInUrlRequest request) {
    ...
    public com.google.common.util.concurrent.ListenableFuture<com.github.saturn_xiv.palm.plugins.auth.v1.UserSignInResponse> signIn(
        com.github.saturn_xiv.palm.plugins.auth.v1.SignInByGoogleRequest request) {
      return io.grpc.stub.ClientCalls.futureUnaryCall(
    ...
    public void invoke(Req request, io.grpc.stub.StreamObserver<Resp> responseObserver) {
      switch (methodId) {
        case METHODID_SIGN_IN_URL:
          serviceImpl.signInUrl((com.github.saturn_xiv.palm.plugins.auth.v1.GoogleSignInUrlRequest) request,
              (io.grpc.stub.StreamObserver<com.github.saturn_xiv.palm.plugins.auth.v1.GoogleSignInUrlResponse>) responseObserver);
          break;
        case METHODID_SIGN_IN:
          serviceImpl.signIn((com.github.saturn_xiv.palm.plugins.auth.v1.SignInByGoogleRequest) request,
              (io.grpc.stub.StreamObserver<com.github.saturn_xiv.palm.plugins.auth.v1.UserSignInResponse>) responseObserver);
          break;
        default:
    ...
    return io.grpc.ServerServiceDefinition.builder(getServiceDescriptor())
        .addMethod(
          ...
          io.grpc.stub.ServerCalls.asyncUnaryCall(
            new MethodHandlers<
              com.github.saturn_xiv.palm.plugins.auth.v1.GoogleSignInUrlRequest,
              com.github.saturn_xiv.palm.plugins.auth.v1.GoogleSignInUrlResponse>(
                service, METHODID_SIGN_IN_URL)))
        .addMethod(
          getSignInMethod(),
          io.grpc.stub.ServerCalls.asyncUnaryCall(
            new MethodHandlers<
              com.github.saturn_xiv.palm.plugins.auth.v1.SignInByGoogleRequest,
