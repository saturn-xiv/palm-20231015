...
public final class AttachmentGrpc {
  ...
  public static final java.lang.String SERVICE_NAME = "palm.metasequoia.v1.Attachment";

  // Static method descriptors that strictly reflect the proto.
  private static volatile io.grpc.MethodDescriptor<com.github.saturn_xiv.palm.plugins.metasequoia.v1.Pager,
      com.github.saturn_xiv.palm.plugins.metasequoia.v1.AttachmentIndexResponse> getIndexMethod;

  @io.grpc.stub.annotations.RpcMethod(
      fullMethodName = SERVICE_NAME + '/' + "Index",
      requestType = com.github.saturn_xiv.palm.plugins.metasequoia.v1.Pager.class,
      responseType = com.github.saturn_xiv.palm.plugins.metasequoia.v1.AttachmentIndexResponse.class,
      methodType = io.grpc.MethodDescriptor.MethodType.UNARY)
  public static io.grpc.MethodDescriptor<com.github.saturn_xiv.palm.plugins.metasequoia.v1.Pager,
      com.github.saturn_xiv.palm.plugins.metasequoia.v1.AttachmentIndexResponse> getIndexMethod() {
    io.grpc.MethodDescriptor<com.github.saturn_xiv.palm.plugins.metasequoia.v1.Pager, com.github.saturn_xiv.palm.plugins.metasequoia.v1.AttachmentIndexResponse> getIndexMethod;
      ...
      synchronized (AttachmentGrpc.class) {
        if ((getIndexMethod = AttachmentGrpc.getIndexMethod) == null) {
          AttachmentGrpc.getIndexMethod = getIndexMethod =
              io.grpc.MethodDescriptor.<com.github.saturn_xiv.palm.plugins.metasequoia.v1.Pager, com.github.saturn_xiv.palm.plugins.metasequoia.v1.AttachmentIndexResponse>newBuilder()
              ...
              .setResponseMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  com.github.saturn_xiv.palm.plugins.metasequoia.v1.AttachmentIndexResponse.getDefaultInstance()))
  ...
  private static volatile io.grpc.MethodDescriptor<com.github.saturn_xiv.palm.plugins.metasequoia.v1.AttachmentShowRequest,
      com.github.saturn_xiv.palm.plugins.metasequoia.v1.AttachmentShowResponse> getShowMethod;

  @io.grpc.stub.annotations.RpcMethod(
      fullMethodName = SERVICE_NAME + '/' + "Show",
      requestType = com.github.saturn_xiv.palm.plugins.metasequoia.v1.AttachmentShowRequest.class,
      responseType = com.github.saturn_xiv.palm.plugins.metasequoia.v1.AttachmentShowResponse.class,
      methodType = io.grpc.MethodDescriptor.MethodType.UNARY)
  public static io.grpc.MethodDescriptor<com.github.saturn_xiv.palm.plugins.metasequoia.v1.AttachmentShowRequest,
      com.github.saturn_xiv.palm.plugins.metasequoia.v1.AttachmentShowResponse> getShowMethod() {
    io.grpc.MethodDescriptor<com.github.saturn_xiv.palm.plugins.metasequoia.v1.AttachmentShowRequest, com.github.saturn_xiv.palm.plugins.metasequoia.v1.AttachmentShowResponse> getShowMethod;
    if ((getShowMethod = AttachmentGrpc.getShowMethod) == null) {
      synchronized (AttachmentGrpc.class) {
        if ((getShowMethod = AttachmentGrpc.getShowMethod) == null) {
          AttachmentGrpc.getShowMethod = getShowMethod =
              io.grpc.MethodDescriptor.<com.github.saturn_xiv.palm.plugins.metasequoia.v1.AttachmentShowRequest, com.github.saturn_xiv.palm.plugins.metasequoia.v1.AttachmentShowResponse>newBuilder()
              .setType(io.grpc.MethodDescriptor.MethodType.UNARY)
              .setFullMethodName(generateFullMethodName(SERVICE_NAME, "Show"))
              .setSampledToLocalTracing(true)
              .setRequestMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  com.github.saturn_xiv.palm.plugins.metasequoia.v1.AttachmentShowRequest.getDefaultInstance()))
              .setResponseMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  com.github.saturn_xiv.palm.plugins.metasequoia.v1.AttachmentShowResponse.getDefaultInstance()))
  ...
  public interface AsyncService {
    ...
    default void index(com.github.saturn_xiv.palm.plugins.metasequoia.v1.Pager request,
        io.grpc.stub.StreamObserver<com.github.saturn_xiv.palm.plugins.metasequoia.v1.AttachmentIndexResponse> responseObserver) {
    ...
    /**
     */
    default void show(com.github.saturn_xiv.palm.plugins.metasequoia.v1.AttachmentShowRequest request,
        io.grpc.stub.StreamObserver<com.github.saturn_xiv.palm.plugins.metasequoia.v1.AttachmentShowResponse> responseObserver) {
  ...
  public static final class AttachmentStub
    ...
    /**
     */
    public void show(com.github.saturn_xiv.palm.plugins.metasequoia.v1.AttachmentShowRequest request,
        io.grpc.stub.StreamObserver<com.github.saturn_xiv.palm.plugins.metasequoia.v1.AttachmentShowResponse> responseObserver) {
      io.grpc.stub.ClientCalls.asyncUnaryCall(
  ...
  public static final class AttachmentBlockingStub
    ...
    /**
     */
    public com.github.saturn_xiv.palm.plugins.metasequoia.v1.AttachmentIndexResponse index(com.github.saturn_xiv.palm.plugins.metasequoia.v1.Pager request) {
    ...
    /**
     */
    public com.github.saturn_xiv.palm.plugins.metasequoia.v1.AttachmentShowResponse show(com.github.saturn_xiv.palm.plugins.metasequoia.v1.AttachmentShowRequest request) {
      return io.grpc.stub.ClientCalls.blockingUnaryCall(
  ...
  public static final class AttachmentFutureStub
    ...
    /**
     */
    public com.google.common.util.concurrent.ListenableFuture<com.github.saturn_xiv.palm.plugins.metasequoia.v1.AttachmentIndexResponse> index(
    ...
    /**
     */
    public com.google.common.util.concurrent.ListenableFuture<com.github.saturn_xiv.palm.plugins.metasequoia.v1.AttachmentShowResponse> show(
        com.github.saturn_xiv.palm.plugins.metasequoia.v1.AttachmentShowRequest request) {
      return io.grpc.stub.ClientCalls.futureUnaryCall(
    ...
    public void invoke(Req request, io.grpc.stub.StreamObserver<Resp> responseObserver) {
      switch (methodId) {
        ...
        case METHODID_DESTROY:
          ...
          break;
        case METHODID_SHOW:
          serviceImpl.show((com.github.saturn_xiv.palm.plugins.metasequoia.v1.AttachmentShowRequest) request,
              (io.grpc.stub.StreamObserver<com.github.saturn_xiv.palm.plugins.metasequoia.v1.AttachmentShowResponse>) responseObserver);
          break;
        default:
  ...
  public static final io.grpc.ServerServiceDefinition bindService(AsyncService service) {
    return io.grpc.ServerServiceDefinition.builder(getServiceDescriptor())
        .addMethod(
          ...
          io.grpc.stub.ServerCalls.asyncUnaryCall(
            new MethodHandlers<
              ...
              com.github.saturn_xiv.palm.plugins.metasequoia.v1.AttachmentIndexResponse>(
        ...
        .addMethod(
          ...
          io.grpc.stub.ServerCalls.asyncUnaryCall(
            new MethodHandlers<
              com.github.saturn_xiv.palm.plugins.metasequoia.v1.AttachmentShowRequest,
              com.github.saturn_xiv.palm.plugins.metasequoia.v1.AttachmentShowResponse>(
