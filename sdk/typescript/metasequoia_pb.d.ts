...
export class SiteInstallRequest extends jspb.Message {
  getUser(): UserSignUpByEmailRequest | undefined;
  setUser(value?: UserSignUpByEmailRequest): SiteInstallRequest;
  hasUser(): boolean;
...
export namespace SiteInstallRequest {
  export type AsObject = {
    user?: UserSignUpByEmailRequest.AsObject,
  }
}
...
export class NotificationIndexResponse extends jspb.Message {
  ...
  getPagination(): Pagination | undefined;
  setPagination(value?: Pagination): NotificationIndexResponse;
  hasPagination(): boolean;
