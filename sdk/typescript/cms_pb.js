...
var metasequoia_pb = require('./metasequoia_pb.js');
goog.object.extend(proto, metasequoia_pb);
...
proto.palm.cms.v1.ArticleCreateRequest.toObject = function(includeInstance, msg) {
  var f, obj = {
    ...
    body: (f = msg.getBody()) && metasequoia_pb.MediaContent.toObject(includeInstance, f),
...
proto.palm.cms.v1.ArticleCreateRequest.deserializeBinaryFromReader = function(msg, reader) {
  while (reader.nextField()) {
    ...
    case 2:
      ...
      break;
    case 3:
      var value = new metasequoia_pb.MediaContent;
      reader.readMessage(value,metasequoia_pb.MediaContent.deserializeBinaryFromReader);
      msg.setBody(value);
      break;
    case 4:
...
proto.palm.cms.v1.ArticleCreateRequest.serializeBinaryToWriter = function(message, writer) {
  ...
  if (f != null) {
    writer.writeMessage(
      3,
      f,
      metasequoia_pb.MediaContent.serializeBinaryToWriter
    );
  }
...
/**
 * optional palm.metasequoia.v1.MediaContent body = 3;
...
proto.palm.cms.v1.ArticleCreateRequest.prototype.getBody = function() {
  return /** @type{?proto.palm.metasequoia.v1.MediaContent} */ (
    jspb.Message.getWrapperField(this, metasequoia_pb.MediaContent, 3));
};
...
proto.palm.cms.v1.ArticleIndexResponse.toObject = function(includeInstance, msg) {
  var f, obj = {
    ...
    pagination: (f = msg.getPagination()) && metasequoia_pb.Pagination.toObject(includeInstance, f)
  };
...
proto.palm.cms.v1.ArticleIndexResponse.deserializeBinaryFromReader = function(msg, reader) {
  while (reader.nextField()) {
    ...
    case 1:
      ...
      break;
    case 9:
      var value = new metasequoia_pb.Pagination;
      reader.readMessage(value,metasequoia_pb.Pagination.deserializeBinaryFromReader);
...
proto.palm.cms.v1.ArticleIndexResponse.serializeBinaryToWriter = function(message, writer) {
  ...
  if (f != null) {
    writer.writeMessage(
      9,
      f,
      metasequoia_pb.Pagination.serializeBinaryToWriter
    );
  }
};
...
proto.palm.cms.v1.ArticleIndexResponse.Item.toObject = function(includeInstance, msg) {
  var f, obj = {
    ...
    author: (f = msg.getAuthor()) && metasequoia_pb.UserDetail.toObject(includeInstance, f),
    tagsList: jspb.Message.toObjectList(msg.getTagsList(),
    metasequoia_pb.TagIndexResponse.Item.toObject, includeInstance)
  };
...
proto.palm.cms.v1.ArticleIndexResponse.Item.deserializeBinaryFromReader = function(msg, reader) {
  while (reader.nextField()) {
    ...
    case 9:
      ...
      break;
    case 11:
      var value = new metasequoia_pb.UserDetail;
      reader.readMessage(value,metasequoia_pb.UserDetail.deserializeBinaryFromReader);
      msg.setAuthor(value);
      break;
    case 12:
      var value = new metasequoia_pb.TagIndexResponse.Item;
      reader.readMessage(value,metasequoia_pb.TagIndexResponse.Item.deserializeBinaryFromReader);
      msg.addTags(value);
      break;
    default:
      reader.skipField();
...
proto.palm.cms.v1.ArticleIndexResponse.Item.serializeBinaryToWriter = function(message, writer) {
  ...
  if (f != null) {
    writer.writeMessage(
      11,
      f,
      metasequoia_pb.UserDetail.serializeBinaryToWriter
    );
  }
  f = message.getTagsList();
  if (f.length > 0) {
    writer.writeRepeatedMessage(
      12,
      f,
      metasequoia_pb.TagIndexResponse.Item.serializeBinaryToWriter
    );
  }
};
...
/**
 * optional palm.metasequoia.v1.MediaContent body = 5;
 * @return {?proto.palm.metasequoia.v1.MediaContent}
 */
proto.palm.cms.v1.ArticleIndexResponse.Item.prototype.getBody = function() {
  return /** @type{?proto.palm.metasequoia.v1.MediaContent} */ (
    jspb.Message.getWrapperField(this, metasequoia_pb.MediaContent, 5));
};
...
/**
 * optional palm.metasequoia.v1.UserDetail author = 11;
 * @return {?proto.palm.metasequoia.v1.UserDetail}
 */
proto.palm.cms.v1.ArticleIndexResponse.Item.prototype.getAuthor = function() {
  return /** @type{?proto.palm.metasequoia.v1.UserDetail} */ (
    jspb.Message.getWrapperField(this, metasequoia_pb.UserDetail, 11));
};


/**
 * @param {?proto.palm.metasequoia.v1.UserDetail|undefined} value
 * @return {!proto.palm.cms.v1.ArticleIndexResponse.Item} returns this
*/
...
proto.palm.cms.v1.ArticleIndexResponse.Item.prototype.getTagsList = function() {
  return /** @type{!Array<!proto.palm.metasequoia.v1.TagIndexResponse.Item>} */ (
    jspb.Message.getRepeatedWrapperField(this, metasequoia_pb.TagIndexResponse.Item, 12));
};
...
proto.palm.cms.v1.ArticleIndexResponse.Item.prototype.addTags = function(opt_value, opt_index) {
  return jspb.Message.addToRepeatedWrapperField(this, 12, opt_value, proto.palm.metasequoia.v1.TagIndexResponse.Item, opt_index);
};
...
/**
 * optional palm.metasequoia.v1.Pagination pagination = 9;
...
proto.palm.cms.v1.ArticleIndexResponse.prototype.getPagination = function() {
  return /** @type{?proto.palm.metasequoia.v1.Pagination} */ (
    jspb.Message.getWrapperField(this, metasequoia_pb.Pagination, 9));
};
...
/**
 * optional palm.metasequoia.v1.MediaContent body = 2;
 * @return {?proto.palm.metasequoia.v1.MediaContent}
 */
proto.palm.cms.v1.CommentCreateRequest.prototype.getBody = function() {
  return /** @type{?proto.palm.metasequoia.v1.MediaContent} */ (
    jspb.Message.getWrapperField(this, metasequoia_pb.MediaContent, 2));
};
