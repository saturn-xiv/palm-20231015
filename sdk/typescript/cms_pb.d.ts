...
export class ArticleCreateRequest extends jspb.Message {
  ...
  getBody(): metasequoia_pb.MediaContent | undefined;
  setBody(value?: metasequoia_pb.MediaContent): ArticleCreateRequest;
  hasBody(): boolean;
...
export namespace ArticleCreateRequest {
  export type AsObject = {
    title: string,
    summary: string,
    body?: metasequoia_pb.MediaContent.AsObject,
...
export class ArticleIndexResponse extends jspb.Message {
  ...
  getPagination(): metasequoia_pb.Pagination | undefined;
  setPagination(value?: metasequoia_pb.Pagination): ArticleIndexResponse;
...
export namespace ArticleIndexResponse {
  export type AsObject = {
    ...
    pagination?: metasequoia_pb.Pagination.AsObject,
  }
  ...
  export class Item extends jspb.Message {
    ...
    getBody(): metasequoia_pb.MediaContent | undefined;
    setBody(value?: metasequoia_pb.MediaContent): Item;
    hasBody(): boolean;
    clearBody(): Item;
    ...
    getAuthor(): metasequoia_pb.UserDetail | undefined;
    setAuthor(value?: metasequoia_pb.UserDetail): Item;
    hasAuthor(): boolean;
    clearAuthor(): Item;

    getTagsList(): Array<metasequoia_pb.TagIndexResponse.Item>;
    setTagsList(value: Array<metasequoia_pb.TagIndexResponse.Item>): Item;
    clearTagsList(): Item;
    addTags(value?: metasequoia_pb.TagIndexResponse.Item, index?: number): metasequoia_pb.TagIndexResponse.Item;
  ...
  export namespace Item {
    export type AsObject = {
      ...
      author?: metasequoia_pb.UserDetail.AsObject,
      tagsList: Array<metasequoia_pb.TagIndexResponse.Item.AsObject>,
    }
  }
...
export class CommentCreateRequest extends jspb.Message {
  ...
  getBody(): metasequoia_pb.MediaContent | undefined;
  setBody(value?: metasequoia_pb.MediaContent): CommentCreateRequest;
  hasBody(): boolean;
...
export class CommentIndexResponse extends jspb.Message {
  ...
  getPagination(): metasequoia_pb.Pagination | undefined;
  setPagination(value?: metasequoia_pb.Pagination): CommentIndexResponse;
  hasPagination(): boolean;
