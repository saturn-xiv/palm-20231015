...
class MarkdownToHtmlResponse final :
    public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:palm.morus.v1.MarkdownToHtmlResponse) */ {
 public:
  ...
  inline MarkdownToHtmlResponse(const MarkdownToHtmlResponse& from)
      : MarkdownToHtmlResponse(nullptr, from) {}
  ...
  MarkdownToHtmlResponse(::google::protobuf::Arena* arena, const MarkdownToHtmlResponse& from);
  public:
...
class MarkdownToHtmlRequest final :
    public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:palm.morus.v1.MarkdownToHtmlRequest) */ {
 public:
  ...
  inline MarkdownToHtmlRequest(const MarkdownToHtmlRequest& from)
      : MarkdownToHtmlRequest(nullptr, from) {}
  ...
  MarkdownToHtmlRequest(::google::protobuf::Arena* arena, const MarkdownToHtmlRequest& from);
  public:
...
inline std::string* MarkdownToHtmlRequest::mutable_payload() ABSL_ATTRIBUTE_LIFETIME_BOUND {
...
inline std::string* MarkdownToHtmlResponse::mutable_payload() ABSL_ATTRIBUTE_LIFETIME_BOUND {
  std::string* _s = _internal_mutable_payload();
