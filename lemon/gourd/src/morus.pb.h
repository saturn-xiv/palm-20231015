...
PROTOBUF_NAMESPACE_OPEN
template <>
::palm::morus::v1::MarkdownToHtmlRequest* Arena::CreateMaybeMessage<::palm::morus::v1::MarkdownToHtmlRequest>(Arena*);
template <>
::palm::morus::v1::MarkdownToHtmlResponse* Arena::CreateMaybeMessage<::palm::morus::v1::MarkdownToHtmlResponse>(Arena*);
PROTOBUF_NAMESPACE_CLOSE
