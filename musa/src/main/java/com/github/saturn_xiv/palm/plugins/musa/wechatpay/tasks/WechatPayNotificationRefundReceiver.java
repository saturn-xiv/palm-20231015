...
@Component("palm.musa.task.wechat-pay.receiver.refund")
public class WechatPayNotificationRefundReceiver {
    ...
    private final static Logger logger = LoggerFactory.getLogger(WechatPayNotificationRefundReceiver.class);
}
