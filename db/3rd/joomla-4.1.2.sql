...
--
-- Table structure for table `jm_action_logs`
--

CREATE TABLE `jm_action_logs` (
...
--
-- Table structure for table `jm_action_logs_extensions`
--

CREATE TABLE `jm_action_logs_extensions` (
  `id` int UNSIGNED NOT NULL,
  `extension` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT ''
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;

--
-- Dumping data for table `jm_action_logs_extensions`
--

INSERT INTO `jm_action_logs_extensions` (`id`, `extension`) VALUES
(1, 'com_banners'),
(2, 'com_cache'),
(3, 'com_categories'),
(4, 'com_config'),
...
--
-- Table structure for table `jm_action_logs_users`
--

CREATE TABLE `jm_action_logs_users` (
...
--
-- Table structure for table `jm_action_log_config`
--

CREATE TABLE `jm_action_log_config` (
  `id` int UNSIGNED NOT NULL,
...
--
-- Dumping data for table `jm_action_log_config`
--

INSERT INTO `jm_action_log_config` (`id`, `type_title`, `type_alias`, `id_holder`, `title_holder`, `table_name`, `text_prefix`) VALUES
...
--
-- Table structure for table `jm_assets`
--
...
--
-- Dumping data for table `jm_assets`
--
...
--
-- Table structure for table `jm_associations`
--
...
--
-- Table structure for table `jm_banners`
--
...
--
-- Table structure for table `jm_banner_clients`
--
...
--
-- Table structure for table `jm_banner_tracks`
--
...
--
-- Table structure for table `jm_categories`
--
...
--
-- Dumping data for table `jm_categories`
--
...
(1, 0, 0, 0, 11, 0, '', 'system', 'ROOT', 'root', '', '', 1, NULL, NULL, 1, '{}', '', '', '{}', 706, '2022-05-01 18:40:40', 706, '2022-05-01 18:40:40', 0, '*', 1),
(2, 27, 1, 1, 2, 1, 'uncategorised', 'com_content', 'Uncategorised', 'uncategorised', '', '', 1, NULL, NULL, 1, '{\"category_layout\":\"\",\"image\":\"\",\"workflow_id\":\"use_default\"}', '', '', '{\"author\":\"\",\"robots\":\"\"}', 706, '2022-05-01 18:40:40', 706, '2022-05-01 18:40:40', 0, '*', 1),
(3, 28, 1, 3, 4, 1, 'uncategorised', 'com_banners', 'Uncategorised', 'uncategorised', '', '', 1, NULL, NULL, 1, '{\"category_layout\":\"\",\"image\":\"\"}', '', '', '{\"author\":\"\",\"robots\":\"\"}', 706, '2022-05-01 18:40:40', 706, '2022-05-01 18:40:40', 0, '*', 1),
(4, 29, 1, 5, 6, 1, 'uncategorised', 'com_contact', 'Uncategorised', 'uncategorised', '', '', 1, NULL, NULL, 1, '{\"category_layout\":\"\",\"image\":\"\"}', '', '', '{\"author\":\"\",\"robots\":\"\"}', 706, '2022-05-01 18:40:40', 706, '2022-05-01 18:40:40', 0, '*', 1),
(5, 30, 1, 7, 8, 1, 'uncategorised', 'com_newsfeeds', 'Uncategorised', 'uncategorised', '', '', 1, NULL, NULL, 1, '{\"category_layout\":\"\",\"image\":\"\"}', '', '', '{\"author\":\"\",\"robots\":\"\"}', 706, '2022-05-01 18:40:40', 706, '2022-05-01 18:40:40', 0, '*', 1),
(7, 32, 1, 9, 10, 1, 'uncategorised', 'com_users', 'Uncategorised', 'uncategorised', '', '', 1, NULL, NULL, 1, '{\"category_layout\":\"\",\"image\":\"\"}', '', '', '{\"author\":\"\",\"robots\":\"\"}', 706, '2022-05-01 18:40:40', 706, '2022-05-01 18:40:40', 0, '*', 1);

-- --------------------------------------------------------

--
-- Table structure for table `jm_contact_details`
--
...
--
-- Table structure for table `jm_content`
--
...
--
-- Table structure for table `jm_contentitem_tag_map`
--
...
--
-- Table structure for table `jm_content_frontpage`
--
...
--
-- Table structure for table `jm_content_rating`
--
...
--
-- Table structure for table `jm_content_types`
--
...
--
-- Dumping data for table `jm_content_types`
--
...
--
-- Table structure for table `jm_extensions`
--
...
--
-- Dumping data for table `jm_extensions`
--

INSERT INTO `jm_extensions` (`extension_id`, `package_id`, `name`, `type`, `element`, `changelogurl`, `folder`, `client_id`, `enabled`, `access`, `protected`, `locked`, `manifest_cache`, `params`, `custom_data`, `checked_out`, `checked_out_time`, `ordering`, `state`, `note`) VALUES
...
--
-- Table structure for table `jm_fields`
--
...
--
-- Table structure for table `jm_fields_categories`
--
...
--
-- Table structure for table `jm_fields_groups`
--
...
--
-- Table structure for table `jm_fields_values`
--
...
--
-- Table structure for table `jm_finder_filters`
--
...
--
-- Table structure for table `jm_finder_links`
--
...
--
-- Table structure for table `jm_finder_links_terms`
--

CREATE TABLE `jm_finder_links_terms` (
  `link_id` int UNSIGNED NOT NULL,
...
--
-- Table structure for table `jm_finder_logging`
--

CREATE TABLE `jm_finder_logging` (
...
--
-- Table structure for table `jm_finder_taxonomy`
--
...
--
-- Dumping data for table `jm_finder_taxonomy`
--

INSERT INTO `jm_finder_taxonomy` (`id`, `parent_id`, `lft`, `rgt`, `level`, `path`, `title`, `alias`, `state`, `access`, `language`) VALUES
(1, 0, 0, 1, 0, '', 'ROOT', 'root', 1, 1, '*');

-- --------------------------------------------------------

--
-- Table structure for table `jm_finder_taxonomy_map`
--
...
--
-- Table structure for table `jm_finder_terms`
--
...
--
-- Table structure for table `jm_finder_terms_common`
--
...
--
-- Dumping data for table `jm_finder_terms_common`
--

INSERT INTO `jm_finder_terms_common` (`term`, `language`, `custom`) VALUES
('a', 'en', 0),
('about', 'en', 0),
('above', 'en', 0),
('after', 'en', 0),
...
--
-- Table structure for table `jm_finder_tokens`
--
...
--
-- Table structure for table `jm_finder_tokens_aggregate`
--
...
--
-- Table structure for table `jm_finder_types`
--
...
--
-- Table structure for table `jm_history`
--

CREATE TABLE `jm_history` (
...
--
-- Table structure for table `jm_languages`
--
...
--
-- Dumping data for table `jm_languages`
--
...
--
-- Table structure for table `jm_mail_templates`
--

CREATE TABLE `jm_mail_templates` (
...
--
-- Dumping data for table `jm_mail_templates`
--

INSERT INTO `jm_mail_templates` (`template_id`, `extension`, `language`, `subject`, `body`, `htmlbody`, `attachments`, `params`) VALUES
...
--
-- Table structure for table `jm_menu`
--
...
--
-- Dumping data for table `jm_menu`
--

INSERT INTO `jm_menu` (`id`, `menutype`, `title`, `alias`, `note`, `path`, `link`, `type`, `published`, `parent_id`, `level`, `component_id`, `checked_out`, `checked_out_time`, `browserNav`, `access`, `img`, `template_style_id`, `params`, `lft`, `rgt`, `home`, `language`, `client_id`, `publish_up`, `publish_down`) VALUES
...
--
-- Table structure for table `jm_menu_types`
--
...
--
-- Dumping data for table `jm_menu_types`
--
...
--
-- Table structure for table `jm_messages`
--
...
--
-- Table structure for table `jm_messages_cfg`
--
...
--
-- Table structure for table `jm_modules`
--
...
--
-- Dumping data for table `jm_modules`
--
...
--
-- Table structure for table `jm_modules_menu`
--
...
--
-- Dumping data for table `jm_modules_menu`
--
...
--
-- Table structure for table `jm_newsfeeds`
--
...
--
-- Table structure for table `jm_overrider`
--
...
--
-- Table structure for table `jm_postinstall_messages`
--
...
--
-- Dumping data for table `jm_postinstall_messages`
--
...
--
-- Table structure for table `jm_privacy_consents`
--

CREATE TABLE `jm_privacy_consents` (
  `id` int UNSIGNED NOT NULL,
  `user_id` int UNSIGNED NOT NULL DEFAULT '0',
  `state` int NOT NULL DEFAULT '1',
  `created` datetime NOT NULL,
...
--
-- Table structure for table `jm_privacy_requests`
--

CREATE TABLE `jm_privacy_requests` (
  `id` int UNSIGNED NOT NULL,
...
--
-- Table structure for table `jm_redirect_links`
--
...
--
-- Table structure for table `jm_scheduler_tasks`
--

CREATE TABLE `jm_scheduler_tasks` (
  `id` int UNSIGNED NOT NULL,
  `asset_id` int UNSIGNED NOT NULL DEFAULT '0' COMMENT 'FK to the #__assets table.',
  `title` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT '',
...
--
-- Table structure for table `jm_schemas`
--
...
--
-- Dumping data for table `jm_schemas`
--
...
--
-- Table structure for table `jm_session`
--
...
--
-- Table structure for table `jm_tags`
--
...
--
-- Dumping data for table `jm_tags`
--
...
(1, 0, 0, 1, 0, '', 'ROOT', 'root', '', '', 1, NULL, NULL, 1, '', '', '', '', 706, '2022-05-01 18:40:38', '', 706, '2022-05-01 18:40:38', '', '', 0, '*', 1, NULL, NULL);

-- --------------------------------------------------------

--
-- Table structure for table `jm_template_overrides`
--

CREATE TABLE `jm_template_overrides` (
  `id` int UNSIGNED NOT NULL,
...
--
-- Table structure for table `jm_template_styles`
--
...
--
-- Dumping data for table `jm_template_styles`
--

INSERT INTO `jm_template_styles` (`id`, `template`, `client_id`, `home`, `title`, `inheritable`, `parent`, `params`) VALUES
...
--
-- Table structure for table `jm_ucm_base`
--
...
--
-- Table structure for table `jm_ucm_content`
--
...
--
-- Table structure for table `jm_updates`
--
...
--
-- Dumping data for table `jm_updates`
--

INSERT INTO `jm_updates` (`update_id`, `update_site_id`, `extension_id`, `name`, `description`, `element`, `type`, `folder`, `client_id`, `version`, `data`, `detailsurl`, `infourl`, `changelogurl`, `extra_query`) VALUES
(883, 2, 0, 'Arabic Unitag', '', 'pkg_ar-AA', 'package', '', 0, '4.0.2.1', '', 'https://update.joomla.org/language/details4/ar-AA_details.xml', '', '', ''),
(884, 2, 0, 'Catalan', '', 'pkg_ca-ES', 'package', '', 0, '4.0.4.2', '', 'https://update.joomla.org/language/details4/ca-ES_details.xml', '', '', ''),
(885, 2, 0, 'Chinese, Simplified', '', 'pkg_zh-CN', 'package', '', 0, '4.1.0.3', '', 'https://update.joomla.org/language/details4/zh-CN_details.xml', '', '', ''),
(886, 2, 0, 'Chinese, Traditional', '', 'pkg_zh-TW', 'package', '', 0, '4.0.6.1', '', 'https://update.joomla.org/language/details4/zh-TW_details.xml', '', '', ''),
(887, 2, 0, 'Czech', '', 'pkg_cs-CZ', 'package', '', 0, '4.1.2.1', '', 'https://update.joomla.org/language/details4/cs-CZ_details.xml', '', '', ''),
(888, 2, 0, 'Danish', '', 'pkg_da-DK', 'package', '', 0, '4.1.1.1', '', 'https://update.joomla.org/language/details4/da-DK_details.xml', '', '', ''),
(889, 2, 0, 'Dutch', '', 'pkg_nl-NL', 'package', '', 0, '4.1.2.1', '', 'https://update.joomla.org/language/details4/nl-NL_details.xml', '', '', ''),
(890, 2, 0, 'English, Australia', '', 'pkg_en-AU', 'package', '', 0, '4.1.2.1', '', 'https://update.joomla.org/language/details4/en-AU_details.xml', '', '', ''),
(891, 2, 0, 'English, Canada', '', 'pkg_en-CA', 'package', '', 0, '4.1.2.1', '', 'https://update.joomla.org/language/details4/en-CA_details.xml', '', '', ''),
(892, 2, 0, 'English, New Zealand', '', 'pkg_en-NZ', 'package', '', 0, '4.1.2.1', '', 'https://update.joomla.org/language/details4/en-NZ_details.xml', '', '', ''),
(893, 2, 0, 'English, USA', '', 'pkg_en-US', 'package', '', 0, '4.1.2.1', '', 'https://update.joomla.org/language/details4/en-US_details.xml', '', '', ''),
(894, 2, 0, 'Estonian', '', 'pkg_et-EE', 'package', '', 0, '4.1.0.1', '', 'https://update.joomla.org/language/details4/et-EE_details.xml', '', '', ''),
(895, 2, 0, 'Finnish', '', 'pkg_fi-FI', 'package', '', 0, '4.1.1.2', '', 'https://update.joomla.org/language/details4/fi-FI_details.xml', '', '', ''),
(896, 2, 0, 'Flemish', '', 'pkg_nl-BE', 'package', '', 0, '4.1.2.1', '', 'https://update.joomla.org/language/details4/nl-BE_details.xml', '', '', ''),
(897, 2, 0, 'French', '', 'pkg_fr-FR', 'package', '', 0, '4.1.2.1', '', 'https://update.joomla.org/language/details4/fr-FR_details.xml', '', '', ''),
(898, 2, 0, 'Georgian', '', 'pkg_ka-GE', 'package', '', 0, '4.1.2.1', '', 'https://update.joomla.org/language/details4/ka-GE_details.xml', '', '', ''),
(899, 2, 0, 'German', '', 'pkg_de-DE', 'package', '', 0, '4.1.2.1', '', 'https://update.joomla.org/language/details4/de-DE_details.xml', '', '', ''),
(900, 2, 0, 'German, Austria', '', 'pkg_de-AT', 'package', '', 0, '4.1.2.1', '', 'https://update.joomla.org/language/details4/de-AT_details.xml', '', '', ''),
(901, 2, 0, 'German, Liechtenstein', '', 'pkg_de-LI', 'package', '', 0, '4.1.2.1', '', 'https://update.joomla.org/language/details4/de-LI_details.xml', '', '', ''),
(902, 2, 0, 'German, Luxembourg', '', 'pkg_de-LU', 'package', '', 0, '4.1.2.1', '', 'https://update.joomla.org/language/details4/de-LU_details.xml', '', '', ''),
(903, 2, 0, 'German, Switzerland', '', 'pkg_de-CH', 'package', '', 0, '4.1.2.1', '', 'https://update.joomla.org/language/details4/de-CH_details.xml', '', '', ''),
(904, 2, 0, 'Greek', '', 'pkg_el-GR', 'package', '', 0, '4.1.2.1', '', 'https://update.joomla.org/language/details4/el-GR_details.xml', '', '', ''),
(905, 2, 0, 'Hungarian', '', 'pkg_hu-HU', 'package', '', 0, '4.1.2.1', '', 'https://update.joomla.org/language/details4/hu-HU_details.xml', '', '', ''),
(906, 2, 0, 'Italian', '', 'pkg_it-IT', 'package', '', 0, '4.1.2.1', '', 'https://update.joomla.org/language/details4/it-IT_details.xml', '', '', ''),
(907, 2, 0, 'Japanese', '', 'pkg_ja-JP', 'package', '', 0, '4.1.2.1', '', 'https://update.joomla.org/language/details4/ja-JP_details.xml', '', '', ''),
(908, 2, 0, 'Kazakh', '', 'pkg_kk-KZ', 'package', '', 0, '4.1.2.1', '', 'https://update.joomla.org/language/details4/kk-KZ_details.xml', '', '', ''),
(909, 2, 0, 'Norwegian Bokmål', '', 'pkg_nb-NO', 'package', '', 0, '4.0.1.1', '', 'https://update.joomla.org/language/details4/nb-NO_details.xml', '', '', ''),
(910, 2, 0, 'Persian Farsi', '', 'pkg_fa-IR', 'package', '', 0, '4.1.2.1', '', 'https://update.joomla.org/language/details4/fa-IR_details.xml', '', '', ''),
(911, 2, 0, 'Polish', '', 'pkg_pl-PL', 'package', '', 0, '4.1.0.5', '', 'https://update.joomla.org/language/details4/pl-PL_details.xml', '', '', ''),
(912, 2, 0, 'Portuguese, Brazil', '', 'pkg_pt-BR', 'package', '', 0, '4.0.3.1', '', 'https://update.joomla.org/language/details4/pt-BR_details.xml', '', '', ''),
(913, 2, 0, 'Portuguese, Portugal', '', 'pkg_pt-PT', 'package', '', 0, '4.0.0-rc4.2', '', 'https://update.joomla.org/language/details4/pt-PT_details.xml', '', '', ''),
(914, 2, 0, 'Romanian', '', 'pkg_ro-RO', 'package', '', 0, '4.1.2.1', '', 'https://update.joomla.org/language/details4/ro-RO_details.xml', '', '', ''),
(915, 2, 0, 'Russian', '', 'pkg_ru-RU', 'package', '', 0, '4.1.1.1', '', 'https://update.joomla.org/language/details4/ru-RU_details.xml', '', '', ''),
(916, 2, 0, 'Slovak', '', 'pkg_sk-SK', 'package', '', 0, '4.0.6.1', '', 'https://update.joomla.org/language/details4/sk-SK_details.xml', '', '', ''),
(917, 2, 0, 'Slovenian', '', 'pkg_sl-SI', 'package', '', 0, '4.1.2.1', '', 'https://update.joomla.org/language/details4/sl-SI_details.xml', '', '', ''),
(918, 2, 0, 'Spanish', '', 'pkg_es-ES', 'package', '', 0, '4.1.2.1', '', 'https://update.joomla.org/language/details4/es-ES_details.xml', '', '', ''),
(919, 2, 0, 'Swedish', '', 'pkg_sv-SE', 'package', '', 0, '4.1.2.1', '', 'https://update.joomla.org/language/details4/sv-SE_details.xml', '', '', ''),
(920, 2, 0, 'Tamil, India', '', 'pkg_ta-IN', 'package', '', 0, '4.1.2.1', '', 'https://update.joomla.org/language/details4/ta-IN_details.xml', '', '', ''),
(921, 2, 0, 'Thai', '', 'pkg_th-TH', 'package', '', 0, '4.1.2.1', '', 'https://update.joomla.org/language/details4/th-TH_details.xml', '', '', ''),
(922, 2, 0, 'Turkish', '', 'pkg_tr-TR', 'package', '', 0, '4.1.2.1', '', 'https://update.joomla.org/language/details4/tr-TR_details.xml', '', '', ''),
(923, 2, 0, 'Ukrainian', '', 'pkg_uk-UA', 'package', '', 0, '4.0.3.2', '', 'https://update.joomla.org/language/details4/uk-UA_details.xml', '', '', ''),
(924, 2, 0, 'Welsh', '', 'pkg_cy-GB', 'package', '', 0, '4.1.2.1', '', 'https://update.joomla.org/language/details4/cy-GB_details.xml', '', '', '');

-- --------------------------------------------------------

--
-- Table structure for table `jm_update_sites`
--
...
--
-- Dumping data for table `jm_update_sites`
--

INSERT INTO `jm_update_sites` (`update_site_id`, `name`, `type`, `location`, `enabled`, `last_check_timestamp`, `extra_query`, `checked_out`, `checked_out_time`) VALUES
(1, 'Joomla! Core', 'collection', 'https://update.joomla.org/core/list.xml', 1, 0, '', NULL, NULL),
(2, 'Accredited Joomla! Translations', 'collection', 'https://update.joomla.org/language/translationlist_4.xml', 1, 1651436757, '', NULL, NULL),
...
--
-- Table structure for table `jm_update_sites_extensions`
--
...
--
-- Dumping data for table `jm_update_sites_extensions`
--
...
--
-- Table structure for table `jm_usergroups`
--
...
--
-- Dumping data for table `jm_usergroups`
--
...
INSERT INTO `jm_users` (`id`, `name`, `username`, `email`, `password`, `block`, `sendEmail`, `registerDate`, `lastvisitDate`, `activation`, `params`, `lastResetTime`, `resetCount`, `otpKey`, `otep`, `requireReset`, `authProvider`) VALUES
(706, 'Administrator', 'admin', 'admin@change-me.com', '$2y$10$xNGSV3jXR0C9IzRFkUU3L.MIyNuXULshOpkCwpIaR3W7YBujSdSiW', 0, 1, '2022-05-01 18:40:51', NULL, '0', '', NULL, 0, '', '', 0, '');

-- --------------------------------------------------------

--
-- Table structure for table `jm_user_keys`
--
...
--
-- Table structure for table `jm_user_notes`
--
...
--
-- Table structure for table `jm_user_profiles`
--
...
--
-- Table structure for table `jm_user_usergroup_map`
--
...
--
-- Dumping data for table `jm_user_usergroup_map`
--
...
--
-- Table structure for table `jm_viewlevels`
--
...
--
-- Dumping data for table `jm_viewlevels`
--
...
--
-- Table structure for table `jm_webauthn_credentials`
--

CREATE TABLE `jm_webauthn_credentials` (
...
--
-- Table structure for table `jm_workflows`
--

CREATE TABLE `jm_workflows` (
  `id` int NOT NULL,
...
--
-- Dumping data for table `jm_workflows`
--

INSERT INTO `jm_workflows` (`id`, `asset_id`, `published`, `title`, `description`, `extension`, `default`, `ordering`, `created`, `created_by`, `modified`, `modified_by`, `checked_out_time`, `checked_out`) VALUES
(1, 56, 1, 'COM_WORKFLOW_BASIC_WORKFLOW', '', 'com_content.article', 1, 1, '2022-05-01 18:40:39', 706, '2022-05-01 18:40:39', 706, NULL, NULL);

-- --------------------------------------------------------

--
-- Table structure for table `jm_workflow_associations`
--

CREATE TABLE `jm_workflow_associations` (
...
--
-- Table structure for table `jm_workflow_stages`
--

CREATE TABLE `jm_workflow_stages` (
  `id` int NOT NULL,
  `asset_id` int DEFAULT '0',
  `ordering` int NOT NULL DEFAULT '0',
...
--
-- Dumping data for table `jm_workflow_stages`
--

INSERT INTO `jm_workflow_stages` (`id`, `asset_id`, `ordering`, `workflow_id`, `published`, `title`, `description`, `default`, `checked_out_time`, `checked_out`) VALUES
(1, 57, 1, 1, 1, 'COM_WORKFLOW_BASIC_STAGE', '', 1, NULL, NULL);

-- --------------------------------------------------------

--
-- Table structure for table `jm_workflow_transitions`
--

CREATE TABLE `jm_workflow_transitions` (
  `id` int NOT NULL,
  `asset_id` int DEFAULT '0',
  `ordering` int NOT NULL DEFAULT '0',
  `workflow_id` int NOT NULL,
...
--
-- Dumping data for table `jm_workflow_transitions`
--

INSERT INTO `jm_workflow_transitions` (`id`, `asset_id`, `ordering`, `workflow_id`, `published`, `title`, `description`, `from_stage_id`, `to_stage_id`, `options`, `checked_out_time`, `checked_out`) VALUES
...
--
-- Indexes for table `jm_action_logs`
--
ALTER TABLE `jm_action_logs`
  ADD PRIMARY KEY (`id`),
...
--
-- Indexes for table `jm_action_logs_extensions`
--
ALTER TABLE `jm_action_logs_extensions`
  ADD PRIMARY KEY (`id`);

--
-- Indexes for table `jm_action_logs_users`
--
ALTER TABLE `jm_action_logs_users`
  ADD PRIMARY KEY (`user_id`),
  ADD KEY `idx_notify` (`notify`);

--
-- Indexes for table `jm_action_log_config`
--
ALTER TABLE `jm_action_log_config`
  ADD PRIMARY KEY (`id`);

--
-- Indexes for table `jm_assets`
--
...
--
-- Indexes for table `jm_associations`
--
...
--
-- Indexes for table `jm_banner_clients`
--
...
--
-- Indexes for table `jm_banner_tracks`
--
...
--
-- Indexes for table `jm_categories`
--
...
--
-- Indexes for table `jm_contact_details`
--
...
--
-- Indexes for table `jm_contentitem_tag_map`
--
...
--
-- Indexes for table `jm_content_frontpage`
--
ALTER TABLE `jm_content_frontpage`
  ADD PRIMARY KEY (`content_id`);

--
-- Indexes for table `jm_content_rating`
--
ALTER TABLE `jm_content_rating`
  ADD PRIMARY KEY (`content_id`);

--
-- Indexes for table `jm_content_types`
--
...
--
-- Indexes for table `jm_extensions`
--
...
--
-- Indexes for table `jm_fields_categories`
--
ALTER TABLE `jm_fields_categories`
  ADD PRIMARY KEY (`field_id`,`category_id`);

--
-- Indexes for table `jm_fields_groups`
--
...
--
-- Indexes for table `jm_fields_values`
--
...
--
-- Indexes for table `jm_finder_filters`
--
ALTER TABLE `jm_finder_filters`
  ADD PRIMARY KEY (`filter_id`);

--
-- Indexes for table `jm_finder_links`
--
...
--
-- Indexes for table `jm_finder_links_terms`
--
ALTER TABLE `jm_finder_links_terms`
  ADD PRIMARY KEY (`link_id`,`term_id`),
  ADD KEY `idx_term_weight` (`term_id`,`weight`),
  ADD KEY `idx_link_term_weight` (`link_id`,`term_id`,`weight`);

--
-- Indexes for table `jm_finder_logging`
--
ALTER TABLE `jm_finder_logging`
  ADD PRIMARY KEY (`md5sum`),
  ADD KEY `searchterm` (`searchterm`(191));

--
-- Indexes for table `jm_finder_taxonomy`
--
...
--
-- Indexes for table `jm_finder_taxonomy_map`
--
...
--
-- Indexes for table `jm_finder_terms`
--
...
--
-- Indexes for table `jm_finder_terms_common`
--
...
--
-- Indexes for table `jm_finder_tokens`
--
...
--
-- Indexes for table `jm_finder_tokens_aggregate`
--
...
--
-- Indexes for table `jm_finder_types`
--
...
--
-- Indexes for table `jm_history`
--
ALTER TABLE `jm_history`
  ADD PRIMARY KEY (`version_id`),
  ADD KEY `idx_ucm_item_id` (`item_id`),
  ADD KEY `idx_save_date` (`save_date`);

--
-- Indexes for table `jm_languages`
--
...
--
-- Indexes for table `jm_mail_templates`
--
ALTER TABLE `jm_mail_templates`
  ADD PRIMARY KEY (`template_id`,`language`);

--
-- Indexes for table `jm_menu`
--
ALTER TABLE `jm_menu`
  ADD PRIMARY KEY (`id`),
...
--
-- Indexes for table `jm_menu_types`
--
...
--
-- Indexes for table `jm_messages_cfg`
--
ALTER TABLE `jm_messages_cfg`
  ADD UNIQUE KEY `idx_user_var_name` (`user_id`,`cfg_name`);

--
-- Indexes for table `jm_modules`
--
...
--
-- Indexes for table `jm_modules_menu`
--
ALTER TABLE `jm_modules_menu`
  ADD PRIMARY KEY (`moduleid`,`menuid`);

--
-- Indexes for table `jm_newsfeeds`
--
...
--
-- Indexes for table `jm_overrider`
--
ALTER TABLE `jm_overrider`
  ADD PRIMARY KEY (`id`);

--
-- Indexes for table `jm_postinstall_messages`
--
ALTER TABLE `jm_postinstall_messages`
  ADD PRIMARY KEY (`postinstall_message_id`);

--
-- Indexes for table `jm_privacy_consents`
--
ALTER TABLE `jm_privacy_consents`
  ADD PRIMARY KEY (`id`),
  ADD KEY `idx_user_id` (`user_id`);

--
-- Indexes for table `jm_privacy_requests`
--
ALTER TABLE `jm_privacy_requests`
  ADD PRIMARY KEY (`id`);

--
-- Indexes for table `jm_redirect_links`
--
...
--
-- Indexes for table `jm_scheduler_tasks`
--
ALTER TABLE `jm_scheduler_tasks`
  ADD PRIMARY KEY (`id`),
...
--
-- Indexes for table `jm_schemas`
--
ALTER TABLE `jm_schemas`
  ADD PRIMARY KEY (`extension_id`,`version_id`);

--
-- Indexes for table `jm_session`
--
...
--
-- Indexes for table `jm_template_overrides`
--
ALTER TABLE `jm_template_overrides`
  ADD PRIMARY KEY (`id`),
  ADD KEY `idx_template` (`template`),
  ADD KEY `idx_extension_id` (`extension_id`);

--
-- Indexes for table `jm_template_styles`
--
...
--
-- Indexes for table `jm_ucm_content`
--
...
--
-- Indexes for table `jm_updates`
--
ALTER TABLE `jm_updates`
  ADD PRIMARY KEY (`update_id`);

--
-- Indexes for table `jm_update_sites`
--
ALTER TABLE `jm_update_sites`
  ADD PRIMARY KEY (`update_site_id`);

--
-- Indexes for table `jm_update_sites_extensions`
--
ALTER TABLE `jm_update_sites_extensions`
  ADD PRIMARY KEY (`update_site_id`,`extension_id`);

--
-- Indexes for table `jm_usergroups`
--
...
--
-- Indexes for table `jm_user_keys`
--
...
--
-- Indexes for table `jm_user_notes`
--
...
--
-- Indexes for table `jm_user_profiles`
--
ALTER TABLE `jm_user_profiles`
  ADD UNIQUE KEY `idx_user_id_profile_key` (`user_id`,`profile_key`);

--
-- Indexes for table `jm_user_usergroup_map`
--
ALTER TABLE `jm_user_usergroup_map`
  ADD PRIMARY KEY (`user_id`,`group_id`);

--
-- Indexes for table `jm_viewlevels`
--
...
--
-- Indexes for table `jm_webauthn_credentials`
--
ALTER TABLE `jm_webauthn_credentials`
  ADD PRIMARY KEY (`id`(100)),
  ADD KEY `user_id` (`user_id`(100));

--
-- Indexes for table `jm_workflows`
--
...
--
-- Indexes for table `jm_workflow_associations`
--
ALTER TABLE `jm_workflow_associations`
...
--
-- Indexes for table `jm_workflow_stages`
--
ALTER TABLE `jm_workflow_stages`
  ADD PRIMARY KEY (`id`),
...
--
-- Indexes for table `jm_workflow_transitions`
--
ALTER TABLE `jm_workflow_transitions`
  ADD PRIMARY KEY (`id`),
  ADD KEY `idx_title` (`title`(191)),
  ADD KEY `idx_asset_id` (`asset_id`),
  ADD KEY `idx_checked_out` (`checked_out`),
...
--
-- AUTO_INCREMENT for table `jm_action_logs`
--
ALTER TABLE `jm_action_logs`
  MODIFY `id` int UNSIGNED NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT for table `jm_action_logs_extensions`
--
ALTER TABLE `jm_action_logs_extensions`
  MODIFY `id` int UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=20;

--
-- AUTO_INCREMENT for table `jm_action_log_config`
--
ALTER TABLE `jm_action_log_config`
  MODIFY `id` int UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=21;

--
-- AUTO_INCREMENT for table `jm_assets`
--
ALTER TABLE `jm_assets`
  MODIFY `id` int UNSIGNED NOT NULL AUTO_INCREMENT COMMENT 'Primary Key', AUTO_INCREMENT=91;

--
-- AUTO_INCREMENT for table `jm_banners`
--
ALTER TABLE `jm_banners`
  MODIFY `id` int NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT for table `jm_banner_clients`
--
ALTER TABLE `jm_banner_clients`
  MODIFY `id` int NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT for table `jm_categories`
--
ALTER TABLE `jm_categories`
  MODIFY `id` int NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=8;

--
-- AUTO_INCREMENT for table `jm_contact_details`
--
ALTER TABLE `jm_contact_details`
  MODIFY `id` int NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT for table `jm_content`
--
ALTER TABLE `jm_content`
  MODIFY `id` int UNSIGNED NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT for table `jm_content_types`
--
ALTER TABLE `jm_content_types`
  MODIFY `type_id` int UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=10000;

--
-- AUTO_INCREMENT for table `jm_extensions`
--
ALTER TABLE `jm_extensions`
  MODIFY `extension_id` int NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=225;

--
-- AUTO_INCREMENT for table `jm_fields`
--
ALTER TABLE `jm_fields`
  MODIFY `id` int UNSIGNED NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT for table `jm_fields_groups`
--
ALTER TABLE `jm_fields_groups`
  MODIFY `id` int UNSIGNED NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT for table `jm_finder_filters`
--
ALTER TABLE `jm_finder_filters`
  MODIFY `filter_id` int UNSIGNED NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT for table `jm_finder_links`
--
ALTER TABLE `jm_finder_links`
  MODIFY `link_id` int UNSIGNED NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT for table `jm_finder_taxonomy`
--
ALTER TABLE `jm_finder_taxonomy`
  MODIFY `id` int UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=2;

--
-- AUTO_INCREMENT for table `jm_finder_terms`
--
ALTER TABLE `jm_finder_terms`
  MODIFY `term_id` int UNSIGNED NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT for table `jm_finder_types`
--
ALTER TABLE `jm_finder_types`
  MODIFY `id` int UNSIGNED NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT for table `jm_history`
--
ALTER TABLE `jm_history`
  MODIFY `version_id` int UNSIGNED NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT for table `jm_languages`
--
ALTER TABLE `jm_languages`
  MODIFY `lang_id` int UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=2;

--
-- AUTO_INCREMENT for table `jm_menu`
--
ALTER TABLE `jm_menu`
  MODIFY `id` int NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=102;

--
-- AUTO_INCREMENT for table `jm_menu_types`
--
ALTER TABLE `jm_menu_types`
  MODIFY `id` int UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=2;

--
-- AUTO_INCREMENT for table `jm_messages`
--
ALTER TABLE `jm_messages`
  MODIFY `message_id` int UNSIGNED NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT for table `jm_modules`
--
ALTER TABLE `jm_modules`
  MODIFY `id` int NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=109;

--
-- AUTO_INCREMENT for table `jm_newsfeeds`
--
ALTER TABLE `jm_newsfeeds`
  MODIFY `id` int UNSIGNED NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT for table `jm_overrider`
--
ALTER TABLE `jm_overrider`
  MODIFY `id` int NOT NULL AUTO_INCREMENT COMMENT 'Primary Key';

--
-- AUTO_INCREMENT for table `jm_postinstall_messages`
--
ALTER TABLE `jm_postinstall_messages`
  MODIFY `postinstall_message_id` bigint UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=6;

--
-- AUTO_INCREMENT for table `jm_privacy_consents`
--
ALTER TABLE `jm_privacy_consents`
  MODIFY `id` int UNSIGNED NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT for table `jm_privacy_requests`
--
ALTER TABLE `jm_privacy_requests`
  MODIFY `id` int UNSIGNED NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT for table `jm_redirect_links`
--
ALTER TABLE `jm_redirect_links`
  MODIFY `id` int UNSIGNED NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT for table `jm_scheduler_tasks`
--
ALTER TABLE `jm_scheduler_tasks`
  MODIFY `id` int UNSIGNED NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT for table `jm_tags`
--
ALTER TABLE `jm_tags`
  MODIFY `id` int UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=2;

--
-- AUTO_INCREMENT for table `jm_template_overrides`
--
ALTER TABLE `jm_template_overrides`
  MODIFY `id` int UNSIGNED NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT for table `jm_template_styles`
--
ALTER TABLE `jm_template_styles`
  MODIFY `id` int UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=12;

--
-- AUTO_INCREMENT for table `jm_ucm_content`
--
ALTER TABLE `jm_ucm_content`
  MODIFY `core_content_id` int UNSIGNED NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT for table `jm_updates`
--
ALTER TABLE `jm_updates`
  MODIFY `update_id` int NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=925;

--
-- AUTO_INCREMENT for table `jm_update_sites`
--
ALTER TABLE `jm_update_sites`
  MODIFY `update_site_id` int NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=4;

--
-- AUTO_INCREMENT for table `jm_usergroups`
--
ALTER TABLE `jm_usergroups`
...
--
-- AUTO_INCREMENT for table `jm_user_keys`
--
ALTER TABLE `jm_user_keys`
  MODIFY `id` int UNSIGNED NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT for table `jm_user_notes`
--
ALTER TABLE `jm_user_notes`
  MODIFY `id` int UNSIGNED NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT for table `jm_viewlevels`
--
ALTER TABLE `jm_viewlevels`
  MODIFY `id` int UNSIGNED NOT NULL AUTO_INCREMENT COMMENT 'Primary Key', AUTO_INCREMENT=7;

--
-- AUTO_INCREMENT for table `jm_workflows`
--
ALTER TABLE `jm_workflows`
  MODIFY `id` int NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=2;

--
-- AUTO_INCREMENT for table `jm_workflow_stages`
--
ALTER TABLE `jm_workflow_stages`
  MODIFY `id` int NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=2;

--
-- AUTO_INCREMENT for table `jm_workflow_transitions`
--
ALTER TABLE `jm_workflow_transitions`
  MODIFY `id` int NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=8;
COMMIT;
