...
pub trait Dao {
    ...
    fn create(&mut self, resource_type: &str, resource_id: i32, star: i32) -> Result<()>;
    fn update(&mut self, id: i32, star: i32) -> Result<()>;
